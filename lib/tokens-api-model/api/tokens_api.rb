...
module AmzSpApi::TokensApiModel
  class TokensApi
    ...
    # @param body The restricted data token request details.
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateRestrictedDataTokenResponse, Fixnum, Hash)>] CreateRestrictedDataTokenResponse data, response status code and response headers
    def create_restricted_data_token_with_http_info(body, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'body' when calling TokensApi.create_restricted_data_token" if body.nil?
      # resource path
      local_var_path = "/tokens/2021-03-01/restrictedDataToken".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'CreateRestrictedDataTokenResponse')
      if @api_client.config.debugging
