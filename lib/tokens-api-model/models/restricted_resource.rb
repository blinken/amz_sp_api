...
module AmzSpApi::TokensApiModel
  ...
  class RestrictedResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dataElements')
        if (value = attributes[:'dataElements']).is_a?(Array)
          self.data_elements = value
        end
      end
    ...
    def valid?
      ...
      method_validator = EnumAttributeValidator.new('String', ["GET", "PUT", "POST", "DELETE"])
    ...
    def method=(method)
      validator = EnumAttributeValidator.new('String', ["GET", "PUT", "POST", "DELETE"])
    ...
    def hash
      [method, path, data_elements].hash
    end
