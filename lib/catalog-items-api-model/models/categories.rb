...
module AmzSpApi::CatalogItemsApiModel
  class Categories
    ...
    attr_accessor :product_category_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ProductCategoryId')
        self.product_category_id = attributes[:'ProductCategoryId']
      end

      if attributes.has_key?(:'ProductCategoryName')
        self.product_category_name = attributes[:'ProductCategoryName']
      end
    ...
    def hash
      [product_category_id, product_category_name, parent].hash
    end
