...
# Models
require 'reports-api-model/models/cancel_report_response'
require 'reports-api-model/models/cancel_report_schedule_response'
require 'reports-api-model/models/create_report_response'
require 'reports-api-model/models/create_report_result'
require 'reports-api-model/models/create_report_schedule_response'
require 'reports-api-model/models/create_report_schedule_result'
...
require 'reports-api-model/models/get_report_document_response'
require 'reports-api-model/models/get_report_response'
require 'reports-api-model/models/get_report_schedule_response'
require 'reports-api-model/models/get_report_schedules_response'
...
require 'reports-api-model/models/report_document_encryption_details'
