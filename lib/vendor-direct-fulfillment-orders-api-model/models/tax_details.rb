...
module AmzSpApi::VendorDirectFulfillmentOrdersApiModel
  class TaxDetails
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['CONSUMPTION', 'GST', 'MwSt.', 'PST', 'TOTAL', 'TVA', 'VAT'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['CONSUMPTION', 'GST', 'MwSt.', 'PST', 'TOTAL', 'TVA', 'VAT'])
    ...
    def hash
      [tax_rate, tax_amount, taxable_amount, type].hash
    end
