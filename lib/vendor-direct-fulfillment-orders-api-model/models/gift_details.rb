...
module AmzSpApi::VendorDirectFulfillmentOrdersApiModel
  ...
  class GiftDetails
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'giftWrapId')
        self.gift_wrap_id = attributes[:'giftWrapId']
      end
    end
    ...
    def hash
      [gift_message, gift_wrap_id].hash
    end
