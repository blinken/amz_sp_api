...
module AmzSpApi::VendorDirectFulfillmentOrdersApiModel
  ...
  class SubmitAcknowledgementRequest
    ...
    attr_accessor :order_acknowledgements
    ...
    def self.swagger_types
      {
        :'order_acknowledgements' => :'Array<OrderAcknowledgementItem>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'orderAcknowledgements')
        if (value = attributes[:'orderAcknowledgements']).is_a?(Array)
          self.order_acknowledgements = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          order_acknowledgements == o.order_acknowledgements
    end
