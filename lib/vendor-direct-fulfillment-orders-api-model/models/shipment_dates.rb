...
module AmzSpApi::VendorDirectFulfillmentOrdersApiModel
  ...
  class ShipmentDates
    ...
    attr_accessor :required_ship_date
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'requiredShipDate')
        self.required_ship_date = attributes[:'requiredShipDate']
      end

      if attributes.has_key?(:'promisedDeliveryDate')
        self.promised_delivery_date = attributes[:'promisedDeliveryDate']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @required_ship_date.nil?
        invalid_properties.push('invalid value for "required_ship_date", required_ship_date cannot be nil.')
      end
    ...
    def valid?
      return false if @required_ship_date.nil?
      true
    end
    ...
    def hash
      [required_ship_date, promised_delivery_date].hash
    end
