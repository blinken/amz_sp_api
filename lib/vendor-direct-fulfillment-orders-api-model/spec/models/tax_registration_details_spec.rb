...
# Unit tests for AmzSpApi::VendorDirectFulfillmentOrdersApiModel::TaxRegistrationDetails
...
describe 'TaxRegistrationDetails' do
  ...
  describe 'test an instance of TaxRegistrationDetails' do
    it 'should create an instact of TaxRegistrationDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentOrdersApiModel::TaxRegistrationDetails)
    end
  end
