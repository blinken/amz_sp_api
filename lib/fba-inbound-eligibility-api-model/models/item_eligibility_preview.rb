...
module AmzSpApi::FbaInboundEligibilityApiModel
  ...
  class ItemEligibilityPreview
    ...
    def self.swagger_types
      {
        ...
        :'program' => :'String',
        :'is_eligible_for_program' => :'BOOLEAN',
        :'ineligibility_reason_list' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isEligibleForProgram')
        self.is_eligible_for_program = attributes[:'isEligibleForProgram']
      end

      if attributes.has_key?(:'ineligibilityReasonList')
        if (value = attributes[:'ineligibilityReasonList']).is_a?(Array)
    ...
    def valid?
      ...
      program_validator = EnumAttributeValidator.new('String', ["INBOUND", "COMMINGLING"])
    ...
    def program=(program)
      validator = EnumAttributeValidator.new('String', ["INBOUND", "COMMINGLING"])
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+), (?<v_type>.+)>\z/
        ...
        temp_model = AmzSpApi::FbaInboundEligibilityApiModel.const_get(type).new
