  ...
  class FbaInboundApi
    ...
    def get_item_eligibility_preview_with_http_info(asin, program, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'marketplace_ids'].nil? && opts[:'marketplace_ids'].length > 1
        fail ArgumentError, 'invalid value for "opts[:"marketplace_ids"]" when calling FbaInboundApi.get_item_eligibility_preview, number of items must be less than or equal to 1.'
      end
