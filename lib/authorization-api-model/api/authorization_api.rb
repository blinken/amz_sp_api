...
module AmzSpApi::AuthorizationApiModel
  class AuthorizationApi
    ...
    # @param mws_auth_token The MWS Auth Token that was generated when the seller authorized your application on the Marketplace Appstore.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetAuthorizationCodeResponse, Fixnum, Hash)>] GetAuthorizationCodeResponse data, response status code and response headers
    def get_authorization_code_with_http_info(selling_partner_id, developer_id, mws_auth_token, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'selling_partner_id' when calling AuthorizationApi.get_authorization_code" if selling_partner_id.nil?
      # verify the required parameter 'developer_id' is set
      fail ArgumentError, "Missing the required parameter 'developer_id' when calling AuthorizationApi.get_authorization_code" if developer_id.nil?
      # verify the required parameter 'mws_auth_token' is set
      fail ArgumentError, "Missing the required parameter 'mws_auth_token' when calling AuthorizationApi.get_authorization_code" if mws_auth_token.nil?
      # resource path
      local_var_path = "/authorization/v1/authorizationCode".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GetAuthorizationCodeResponse')
      if @api_client.config.debugging
