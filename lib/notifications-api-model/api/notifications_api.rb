...
module AmzSpApi::NotificationsApiModel
  class NotificationsApi
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateDestinationResponse, Fixnum, Hash)>] CreateDestinationResponse data, response status code and response headers
    def create_destination_with_http_info(body, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'body' when calling NotificationsApi.create_destination" if body.nil?
      # resource path
      local_var_path = "/notifications/v1/destinations".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'CreateDestinationResponse')
      if @api_client.config.debugging
    ...
    def create_subscription_with_http_info(body, notification_type, opts = {})
      ...
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling NotificationsApi.create_subscription" if body.nil?
      # verify the required parameter 'notification_type' is set
      fail ArgumentError, "Missing the required parameter 'notification_type' when calling NotificationsApi.create_subscription" if notification_type.nil?
      # verify enum value
      unless ['ANY_OFFER_CHANGED', 'FEED_PROCESSING_FINISHED', 'FBA_OUTBOUND_SHIPMENT_STATUS', 'FEE_PROMOTION', 'FULFILLMENT_ORDER_STATUS', 'REPORT_PROCESSING_FINISHED', 'BRANDED_ITEM_CONTENT_CHANGE', 'ITEM_PRODUCT_TYPE_CHANGE', 'LISTINGS_ITEM_STATUS_CHANGE', 'LISTINGS_ITEM_ISSUES_CHANGE', 'MFN_ORDER_STATUS_CHANGE', 'B2B_ANY_OFFER_CHANGED', 'ACCOUNT_STATUS_CHANGED', 'PRODUCT_TYPE_DEFINITIONS_CHANGE'].include?(notification_type)
      ...
      # resource path
      local_var_path = "/notifications/v1/subscriptions/{notificationType}".sub('{format}','json').sub('{' + 'notificationType' + '}', notification_type.to_s)
    ...
    # @param destination_id The identifier for the destination that you want to delete.
    # @param [Hash] opts the optional parameters
    # @return [Array<(DeleteDestinationResponse, Fixnum, Hash)>] DeleteDestinationResponse data, response status code and response headers
    def delete_destination_with_http_info(destination_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'destination_id' when calling NotificationsApi.delete_destination" if destination_id.nil?
      # resource path
      local_var_path = "/notifications/v1/destinations/{destinationId}".sub('{format}','json').sub('{' + 'destinationId' + '}', destination_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'DeleteDestinationResponse')
      if @api_client.config.debugging
    ...
    # @param notification_type The type of notification.   For more information about notification types, see [the Notifications API Use Case Guide](https://github.com/amzn/selling-partner-api-docs/blob/main/guides/en-US/use-case-guides/notifications-api-use-case-guide/notifications-use-case-guide-v1.md).
    # @param [Hash] opts the optional parameters
    # @return [Array<(DeleteSubscriptionByIdResponse, Fixnum, Hash)>] DeleteSubscriptionByIdResponse data, response status code and response headers
    def delete_subscription_by_id_with_http_info(subscription_id, notification_type, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'subscription_id' when calling NotificationsApi.delete_subscription_by_id" if subscription_id.nil?
      # verify the required parameter 'notification_type' is set
      fail ArgumentError, "Missing the required parameter 'notification_type' when calling NotificationsApi.delete_subscription_by_id" if notification_type.nil?
      # verify enum value
      unless ['ANY_OFFER_CHANGED', 'FEED_PROCESSING_FINISHED', 'FBA_OUTBOUND_SHIPMENT_STATUS', 'FEE_PROMOTION', 'FULFILLMENT_ORDER_STATUS', 'REPORT_PROCESSING_FINISHED', 'BRANDED_ITEM_CONTENT_CHANGE', 'ITEM_PRODUCT_TYPE_CHANGE', 'LISTINGS_ITEM_STATUS_CHANGE', 'LISTINGS_ITEM_ISSUES_CHANGE', 'MFN_ORDER_STATUS_CHANGE', 'B2B_ANY_OFFER_CHANGED', 'ACCOUNT_STATUS_CHANGED', 'PRODUCT_TYPE_DEFINITIONS_CHANGE'].include?(notification_type)
        fail ArgumentError, "invalid value for 'notification_type', must be one of ANY_OFFER_CHANGED, FEED_PROCESSING_FINISHED, FBA_OUTBOUND_SHIPMENT_STATUS, FEE_PROMOTION, FULFILLMENT_ORDER_STATUS, REPORT_PROCESSING_FINISHED, BRANDED_ITEM_CONTENT_CHANGE, ITEM_PRODUCT_TYPE_CHANGE, LISTINGS_ITEM_STATUS_CHANGE, LISTINGS_ITEM_ISSUES_CHANGE, MFN_ORDER_STATUS_CHANGE, B2B_ANY_OFFER_CHANGED, ACCOUNT_STATUS_CHANGED, PRODUCT_TYPE_DEFINITIONS_CHANGE"
      end
      # resource path
      local_var_path = "/notifications/v1/subscriptions/{notificationType}/{subscriptionId}".sub('{format}','json').sub('{' + 'subscriptionId' + '}', subscription_id.to_s).sub('{' + 'notificationType' + '}', notification_type.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'DeleteSubscriptionByIdResponse')
      if @api_client.config.debugging
    ...
    # @param destination_id The identifier generated when you created the destination.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetDestinationResponse, Fixnum, Hash)>] GetDestinationResponse data, response status code and response headers
    def get_destination_with_http_info(destination_id, opts = {})
      ...
      # verify the required parameter 'destination_id' is set
      fail ArgumentError, "Missing the required parameter 'destination_id' when calling NotificationsApi.get_destination" if destination_id.nil?
      # resource path
      local_var_path = "/notifications/v1/destinations/{destinationId}".sub('{format}','json').sub('{' + 'destinationId' + '}', destination_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetDestinationResponse')
      if @api_client.config.debugging
    ...
    # Returns information about all destinations. The getDestinations API is grantless. For more information, see \&quot;Grantless operations\&quot; in the Selling Partner API Developer Guide.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 5 |  For more information, see \&quot;Usage Plans and Rate Limits\&quot; in the Selling Partner API documentation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetDestinationsResponse, Fixnum, Hash)>] GetDestinationsResponse data, response status code and response headers
    def get_destinations_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetDestinationsResponse')
      if @api_client.config.debugging
    ...
    def get_subscription_with_http_info(notification_type, opts = {})
      ...
      # verify the required parameter 'notification_type' is set
      fail ArgumentError, "Missing the required parameter 'notification_type' when calling NotificationsApi.get_subscription" if notification_type.nil?
      # verify enum value
      unless ['ANY_OFFER_CHANGED', 'FEED_PROCESSING_FINISHED', 'FBA_OUTBOUND_SHIPMENT_STATUS', 'FEE_PROMOTION', 'FULFILLMENT_ORDER_STATUS', 'REPORT_PROCESSING_FINISHED', 'BRANDED_ITEM_CONTENT_CHANGE', 'ITEM_PRODUCT_TYPE_CHANGE', 'LISTINGS_ITEM_STATUS_CHANGE', 'LISTINGS_ITEM_ISSUES_CHANGE', 'MFN_ORDER_STATUS_CHANGE', 'B2B_ANY_OFFER_CHANGED', 'ACCOUNT_STATUS_CHANGED', 'PRODUCT_TYPE_DEFINITIONS_CHANGE'].include?(notification_type)
        fail ArgumentError, "invalid value for 'notification_type', must be one of ANY_OFFER_CHANGED, FEED_PROCESSING_FINISHED, FBA_OUTBOUND_SHIPMENT_STATUS, FEE_PROMOTION, FULFILLMENT_ORDER_STATUS, REPORT_PROCESSING_FINISHED, BRANDED_ITEM_CONTENT_CHANGE, ITEM_PRODUCT_TYPE_CHANGE, LISTINGS_ITEM_STATUS_CHANGE, LISTINGS_ITEM_ISSUES_CHANGE, MFN_ORDER_STATUS_CHANGE, B2B_ANY_OFFER_CHANGED, ACCOUNT_STATUS_CHANGED, PRODUCT_TYPE_DEFINITIONS_CHANGE"
      end
    ...
    # @param notification_type The type of notification.   For more information about notification types, see [the Notifications API Use Case Guide](https://github.com/amzn/selling-partner-api-docs/blob/main/guides/en-US/use-case-guides/notifications-api-use-case-guide/notifications-use-case-guide-v1.md).
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetSubscriptionByIdResponse, Fixnum, Hash)>] GetSubscriptionByIdResponse data, response status code and response headers
    def get_subscription_by_id_with_http_info(subscription_id, notification_type, opts = {})
      ...
      # verify the required parameter 'subscription_id' is set
      fail ArgumentError, "Missing the required parameter 'subscription_id' when calling NotificationsApi.get_subscription_by_id" if subscription_id.nil?
      # verify the required parameter 'notification_type' is set
      fail ArgumentError, "Missing the required parameter 'notification_type' when calling NotificationsApi.get_subscription_by_id" if notification_type.nil?
      # verify enum value
      unless ['ANY_OFFER_CHANGED', 'FEED_PROCESSING_FINISHED', 'FBA_OUTBOUND_SHIPMENT_STATUS', 'FEE_PROMOTION', 'FULFILLMENT_ORDER_STATUS', 'REPORT_PROCESSING_FINISHED', 'BRANDED_ITEM_CONTENT_CHANGE', 'ITEM_PRODUCT_TYPE_CHANGE', 'LISTINGS_ITEM_STATUS_CHANGE', 'LISTINGS_ITEM_ISSUES_CHANGE', 'MFN_ORDER_STATUS_CHANGE', 'B2B_ANY_OFFER_CHANGED', 'ACCOUNT_STATUS_CHANGED', 'PRODUCT_TYPE_DEFINITIONS_CHANGE'].include?(notification_type)
        fail ArgumentError, "invalid value for 'notification_type', must be one of ANY_OFFER_CHANGED, FEED_PROCESSING_FINISHED, FBA_OUTBOUND_SHIPMENT_STATUS, FEE_PROMOTION, FULFILLMENT_ORDER_STATUS, REPORT_PROCESSING_FINISHED, BRANDED_ITEM_CONTENT_CHANGE, ITEM_PRODUCT_TYPE_CHANGE, LISTINGS_ITEM_STATUS_CHANGE, LISTINGS_ITEM_ISSUES_CHANGE, MFN_ORDER_STATUS_CHANGE, B2B_ANY_OFFER_CHANGED, ACCOUNT_STATUS_CHANGED, PRODUCT_TYPE_DEFINITIONS_CHANGE"
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetSubscriptionByIdResponse')
      if @api_client.config.debugging
