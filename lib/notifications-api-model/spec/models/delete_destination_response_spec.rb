...
# Unit tests for AmzSpApi::NotificationsApiModel::DeleteDestinationResponse
...
describe 'DeleteDestinationResponse' do
  ...
  describe 'test an instance of DeleteDestinationResponse' do
    it 'should create an instact of DeleteDestinationResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::NotificationsApiModel::DeleteDestinationResponse)
    end
  end
