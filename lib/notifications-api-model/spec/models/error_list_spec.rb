...
# Unit tests for AmzSpApi::NotificationsApiModel::ErrorList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ErrorList' do
  before do
    # run before each test
    @instance = AmzSpApi::NotificationsApiModel::ErrorList.new
  end
  ...
  describe 'test an instance of ErrorList' do
    it 'should create an instact of ErrorList' do
      expect(@instance).to be_instance_of(AmzSpApi::NotificationsApiModel::ErrorList)
    end
  end
end
