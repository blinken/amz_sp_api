...
# Unit tests for AmzSpApi::NotificationsApiModel::DestinationList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DestinationList' do
  before do
    # run before each test
    @instance = AmzSpApi::NotificationsApiModel::DestinationList.new
  end
  ...
  describe 'test an instance of DestinationList' do
    it 'should create an instact of DestinationList' do
      expect(@instance).to be_instance_of(AmzSpApi::NotificationsApiModel::DestinationList)
    end
  end
end
