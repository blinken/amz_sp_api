...
# Unit tests for AmzSpApi::NotificationsApiModel::DestinationResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DestinationResource' do
  before do
  ...
  describe 'test an instance of DestinationResource' do
    it 'should create an instance of DestinationResource' do
      expect(@instance).to be_instance_of(AmzSpApi::NotificationsApiModel::DestinationResource)
    end
  end
