...
module AmzSpApi::NotificationsApiModel
  ...
  class Subscription
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'payloadVersion')
        self.payload_version = attributes[:'payloadVersion']
      end
    ...
    def list_invalid_properties
      ...
      if @payload_version.nil?
        invalid_properties.push('invalid value for "payload_version", payload_version cannot be nil.')
      end
