...
module AmzSpApi::SolicitationsApiModel
  class SolicitationsApi
    ...
    # @param marketplace_ids A marketplace identifier. This specifies the marketplace in which the order was placed. Only one marketplace can be specified.
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateProductReviewAndSellerFeedbackSolicitationResponse, Fixnum, Hash)>] CreateProductReviewAndSellerFeedbackSolicitationResponse data, response status code and response headers
    def create_product_review_and_seller_feedback_solicitation_with_http_info(amazon_order_id, marketplace_ids, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'amazon_order_id' when calling SolicitationsApi.create_product_review_and_seller_feedback_solicitation" if amazon_order_id.nil?
      # verify the required parameter 'marketplace_ids' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_ids' when calling SolicitationsApi.create_product_review_and_seller_feedback_solicitation" if marketplace_ids.nil?
      # resource path
      local_var_path = "/solicitations/v1/orders/{amazonOrderId}/solicitations/productReviewAndSellerFeedback".sub('{format}','json').sub('{' + 'amazonOrderId' + '}', amazon_order_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'CreateProductReviewAndSellerFeedbackSolicitationResponse')
      if @api_client.config.debugging
    ...
    # @param marketplace_ids A marketplace identifier. This specifies the marketplace in which the order was placed. Only one marketplace can be specified.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetSolicitationActionsForOrderResponse, Fixnum, Hash)>] GetSolicitationActionsForOrderResponse data, response status code and response headers
    def get_solicitation_actions_for_order_with_http_info(amazon_order_id, marketplace_ids, opts = {})
      ...
      # verify the required parameter 'amazon_order_id' is set
      fail ArgumentError, "Missing the required parameter 'amazon_order_id' when calling SolicitationsApi.get_solicitation_actions_for_order" if amazon_order_id.nil?
      # verify the required parameter 'marketplace_ids' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_ids' when calling SolicitationsApi.get_solicitation_actions_for_order" if marketplace_ids.nil?
      # resource path
      local_var_path = "/solicitations/v1/orders/{amazonOrderId}".sub('{format}','json').sub('{' + 'amazonOrderId' + '}', amazon_order_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetSolicitationActionsForOrderResponse')
      if @api_client.config.debugging
