  ...
  class SolicitationsApi
    ...
    def create_product_review_and_seller_feedback_solicitation_with_http_info(amazon_order_id, marketplace_ids, opts = {})
      ...
      if @api_client.config.client_side_validation && marketplace_ids.length > 1
        fail ArgumentError, 'invalid value for "marketplace_ids" when calling SolicitationsApi.create_product_review_and_seller_feedback_solicitation, number of items must be less than or equal to 1.'
      end
    ...
    def get_solicitation_actions_for_order_with_http_info(amazon_order_id, marketplace_ids, opts = {})
      ...
      if @api_client.config.client_side_validation && marketplace_ids.length > 1
        fail ArgumentError, 'invalid value for "marketplace_ids" when calling SolicitationsApi.get_solicitation_actions_for_order, number of items must be less than or equal to 1.'
      end
