...
module AmzSpApi::ProductTypeDefinitionsApiModel
  ...
  class ProductTypeVersion
    ...
    attr_accessor :release_candidate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'latest')
        self.latest = attributes[:'latest']
      end

      if attributes.has_key?(:'releaseCandidate')
        self.release_candidate = attributes[:'releaseCandidate']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          version == o.version &&
          latest == o.latest &&
          release_candidate == o.release_candidate
    end
    ...
    def hash
      [version, latest, release_candidate].hash
    end
