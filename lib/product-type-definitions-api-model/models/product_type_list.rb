...
module AmzSpApi::ProductTypeDefinitionsApiModel
  ...
  class ProductTypeList
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'productTypes')
        if (value = attributes[:'productTypes']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @product_types.nil?
        invalid_properties.push('invalid value for "product_types", product_types cannot be nil.')
      end
    ...
    def valid?
      return false if @product_types.nil?
      true
    end
