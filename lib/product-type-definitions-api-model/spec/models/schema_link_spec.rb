...
# Unit tests for AmzSpApi::ProductTypeDefinitionsApiModel::SchemaLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SchemaLink' do
  before do
  ...
  describe 'test an instance of SchemaLink' do
    it 'should create an instance of SchemaLink' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductTypeDefinitionsApiModel::SchemaLink)
    end
  end
