...
# Unit tests for AmzSpApi::ProductTypeDefinitionsApiModel::ProductTypeList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductTypeList' do
  before do
  ...
  describe 'test an instance of ProductTypeList' do
    it 'should create an instance of ProductTypeList' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductTypeDefinitionsApiModel::ProductTypeList)
    end
  end
  describe 'test attribute "product_types"' do
    it 'should work' do
