...
# Unit tests for AmzSpApi::ProductTypeDefinitionsApiModel::ProductTypeVersion
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductTypeVersion' do
  before do
  ...
  describe 'test an instance of ProductTypeVersion' do
    it 'should create an instance of ProductTypeVersion' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductTypeDefinitionsApiModel::ProductTypeVersion)
    end
  end
  ...
  describe 'test attribute "release_candidate"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
