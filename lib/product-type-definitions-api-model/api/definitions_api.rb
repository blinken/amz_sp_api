...
module AmzSpApi::ProductTypeDefinitionsApiModel
  class DefinitionsApi
    ...
    # @return [Array<(ProductTypeDefinition, Fixnum, Hash)>] ProductTypeDefinition data, response status code and response headers
    def get_definitions_product_type_with_http_info(product_type, marketplace_ids, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'product_type' when calling DefinitionsApi.get_definitions_product_type" if product_type.nil?
      # verify the required parameter 'marketplace_ids' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_ids' when calling DefinitionsApi.get_definitions_product_type" if marketplace_ids.nil?
      if opts[:'requirements'] && !['LISTING', 'LISTING_PRODUCT_ONLY', 'LISTING_OFFER_ONLY'].include?(opts[:'requirements'])
        fail ArgumentError, 'invalid value for "requirements", must be one of LISTING, LISTING_PRODUCT_ONLY, LISTING_OFFER_ONLY'
      end
      if opts[:'requirements_enforced'] && !['ENFORCED', 'NOT_ENFORCED'].include?(opts[:'requirements_enforced'])
        fail ArgumentError, 'invalid value for "requirements_enforced", must be one of ENFORCED, NOT_ENFORCED'
      end
      if opts[:'locale'] && !['DEFAULT', 'ar', 'ar_AE', 'de', 'de_DE', 'en', 'en_AE', 'en_AU', 'en_CA', 'en_GB', 'en_IN', 'en_SG', 'en_US', 'es', 'es_ES', 'es_MX', 'es_US', 'fr', 'fr_CA', 'fr_FR', 'it', 'it_IT', 'ja', 'ja_JP', 'nl', 'nl_NL', 'pl', 'pl_PL', 'pt', 'pt_BR', 'pt_PT', 'sv', 'sv_SE', 'tr', 'tr_TR', 'zh', 'zh_CN', 'zh_TW'].include?(opts[:'locale'])
      ...
      # resource path
      local_var_path = "/definitions/2020-09-01/productTypes/{productType}".sub('{format}','json').sub('{' + 'productType' + '}', product_type.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ProductTypeDefinition')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :keywords A comma-delimited list of keywords to search product types by.
    # @return [Array<(ProductTypeList, Fixnum, Hash)>] ProductTypeList data, response status code and response headers
    def search_definitions_product_types_with_http_info(marketplace_ids, opts = {})
      ...
      # verify the required parameter 'marketplace_ids' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_ids' when calling DefinitionsApi.search_definitions_product_types" if marketplace_ids.nil?
      # resource path
      local_var_path = "/definitions/2020-09-01/productTypes".sub('{format}','json')
