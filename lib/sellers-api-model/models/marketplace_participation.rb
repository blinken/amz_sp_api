...
module AmzSpApi::SellersApiModel
  class MarketplaceParticipation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'participation')
        self.participation = attributes[:'participation']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @participation.nil?
        invalid_properties.push('invalid value for "participation", participation cannot be nil.')
      end
    ...
    def hash
      [marketplace, participation].hash
    end
