...
module AmzSpApi::FinancesApiModel
  class DefaultApi
    ...
    def list_financial_event_groups_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'max_results_per_page'].nil? && opts[:'max_results_per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"max_results_per_page"]" when calling DefaultApi.list_financial_event_groups, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'max_results_per_page'].nil? && opts[:'max_results_per_page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"max_results_per_page"]" when calling DefaultApi.list_financial_event_groups, must be greater than or equal to 1.'
      end
    ...
    def list_financial_events_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'max_results_per_page'].nil? && opts[:'max_results_per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"max_results_per_page"]" when calling DefaultApi.list_financial_events, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'max_results_per_page'].nil? && opts[:'max_results_per_page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"max_results_per_page"]" when calling DefaultApi.list_financial_events, must be greater than or equal to 1.'
      end
    ...
    def list_financial_events_by_group_id_with_http_info(event_group_id, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'max_results_per_page'].nil? && opts[:'max_results_per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"max_results_per_page"]" when calling DefaultApi.list_financial_events_by_group_id, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'max_results_per_page'].nil? && opts[:'max_results_per_page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"max_results_per_page"]" when calling DefaultApi.list_financial_events_by_group_id, must be greater than or equal to 1.'
      end
    ...
    def list_financial_events_by_order_id_with_http_info(order_id, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'max_results_per_page'].nil? && opts[:'max_results_per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"max_results_per_page"]" when calling DefaultApi.list_financial_events_by_order_id, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'max_results_per_page'].nil? && opts[:'max_results_per_page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"max_results_per_page"]" when calling DefaultApi.list_financial_events_by_order_id, must be greater than or equal to 1.'
      end
