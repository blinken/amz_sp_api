...
module AmzSpApi::FinancesApiModel
  ...
  class FBALiquidationEvent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'OriginalRemovalOrderId')
        self.original_removal_order_id = attributes[:'OriginalRemovalOrderId']
      end

      if attributes.has_key?(:'LiquidationProceedsAmount')
        self.liquidation_proceeds_amount = attributes[:'LiquidationProceedsAmount']
      end

      if attributes.has_key?(:'LiquidationFeeAmount')
        self.liquidation_fee_amount = attributes[:'LiquidationFeeAmount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          original_removal_order_id == o.original_removal_order_id &&
          liquidation_proceeds_amount == o.liquidation_proceeds_amount &&
          liquidation_fee_amount == o.liquidation_fee_amount
    end
    ...
    def hash
      [posted_date, original_removal_order_id, liquidation_proceeds_amount, liquidation_fee_amount].hash
    end
