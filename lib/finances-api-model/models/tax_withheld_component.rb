...
module AmzSpApi::FinancesApiModel
  ...
  class TaxWithheldComponent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TaxesWithheld')
        self.taxes_withheld = attributes[:'TaxesWithheld']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          taxes_withheld == o.taxes_withheld
    end
    ...
    def hash
      [tax_collection_model, taxes_withheld].hash
    end
