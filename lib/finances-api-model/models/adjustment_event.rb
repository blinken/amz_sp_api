...
module AmzSpApi::FinancesApiModel
  ...
  class AdjustmentEvent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AdjustmentType')
        self.adjustment_type = attributes[:'AdjustmentType']
      end
      ...
      if attributes.has_key?(:'AdjustmentItemList')
        self.adjustment_item_list = attributes[:'AdjustmentItemList']
      end
    end
