...
module AmzSpApi::FinancesApiModel
  ...
  class DirectPayment
    ...
    attr_accessor :direct_payment_type

    # The amount of the direct payment.
    attr_accessor :direct_payment_amount
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DirectPaymentType')
        self.direct_payment_type = attributes[:'DirectPaymentType']
      end

      if attributes.has_key?(:'DirectPaymentAmount')
        self.direct_payment_amount = attributes[:'DirectPaymentAmount']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          direct_payment_type == o.direct_payment_type &&
          direct_payment_amount == o.direct_payment_amount
    end
    ...
    def hash
      [direct_payment_type, direct_payment_amount].hash
    end
