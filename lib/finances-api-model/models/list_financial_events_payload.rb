...
module AmzSpApi::FinancesApiModel
  ...
  class ListFinancialEventsPayload
    ...
    attr_accessor :financial_events
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'FinancialEvents')
        self.financial_events = attributes[:'FinancialEvents']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          financial_events == o.financial_events
    end
    ...
    def hash
      [next_token, financial_events].hash
    end
