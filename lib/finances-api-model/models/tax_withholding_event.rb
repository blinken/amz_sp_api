...
module AmzSpApi::FinancesApiModel
  ...
  class TaxWithholdingEvent
    ...
    attr_accessor :tax_withholding_period
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'WithheldAmount')
        self.withheld_amount = attributes[:'WithheldAmount']
      end

      if attributes.has_key?(:'TaxWithholdingPeriod')
        self.tax_withholding_period = attributes[:'TaxWithholdingPeriod']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tax_withholding_period == o.tax_withholding_period
    end
    ...
    def hash
      [posted_date, base_amount, withheld_amount, tax_withholding_period].hash
    end
