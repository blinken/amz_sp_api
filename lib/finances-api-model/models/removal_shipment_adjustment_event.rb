...
module AmzSpApi::FinancesApiModel
  ...
  class RemovalShipmentAdjustmentEvent
    ...
    attr_accessor :adjustment_event_id
    ...
    attr_accessor :removal_shipment_item_adjustment_list
    ...
    def self.swagger_types
      {
        ...
        :'removal_shipment_item_adjustment_list' => :'Array<RemovalShipmentItemAdjustment>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AdjustmentEventId')
        self.adjustment_event_id = attributes[:'AdjustmentEventId']
      end
      ...
      if attributes.has_key?(:'RemovalShipmentItemAdjustmentList')
        if (value = attributes[:'RemovalShipmentItemAdjustmentList']).is_a?(Array)
