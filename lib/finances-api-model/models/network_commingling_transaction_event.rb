...
module AmzSpApi::FinancesApiModel
  ...
  class NetworkComminglingTransactionEvent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'NetCoTransactionID')
        self.net_co_transaction_id = attributes[:'NetCoTransactionID']
      end

      if attributes.has_key?(:'SwapReason')
        self.swap_reason = attributes[:'SwapReason']
      end
      ...
      if attributes.has_key?(:'TaxExclusiveAmount')
        self.tax_exclusive_amount = attributes[:'TaxExclusiveAmount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          net_co_transaction_id == o.net_co_transaction_id &&
          swap_reason == o.swap_reason &&
          asin == o.asin &&
