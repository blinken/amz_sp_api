...
module AmzSpApi::FinancesApiModel
  ...
  class RemovalShipmentItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TaxWithheld')
        self.tax_withheld = attributes[:'TaxWithheld']
      end
    end
    ...
    def hash
      [removal_shipment_item_id, tax_collection_model, fulfillment_network_sku, quantity, revenue, fee_amount, tax_amount, tax_withheld].hash
    end
