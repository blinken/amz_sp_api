...
# Unit tests for AmzSpApi::FinancesApiModel::RemovalShipmentItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RemovalShipmentItem' do
  before do
  ...
  describe 'test an instance of RemovalShipmentItem' do
    it 'should create an instance of RemovalShipmentItem' do
      expect(@instance).to be_instance_of(AmzSpApi::FinancesApiModel::RemovalShipmentItem)
    end
  end
  ...
  describe 'test attribute "tax_withheld"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
