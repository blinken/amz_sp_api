...
module AmzSpApi::FbaSmallAndLightApiModel
  ...
  class FeeLineItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'feeCharge')
        self.fee_charge = attributes[:'feeCharge']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @fee_charge.nil?
        invalid_properties.push('invalid value for "fee_charge", fee_charge cannot be nil.')
      end
    ...
    def valid?
      ...
      fee_type_validator = EnumAttributeValidator.new('String', ['FBAWeightBasedFee', 'FBAPerOrderFulfillmentFee', 'FBAPerUnitFulfillmentFee', 'Commission'])
      return false unless fee_type_validator.valid?(@fee_type)
      return false if @fee_charge.nil?
      true
    end
    ...
    def fee_type=(fee_type)
      validator = EnumAttributeValidator.new('String', ['FBAWeightBasedFee', 'FBAPerOrderFulfillmentFee', 'FBAPerUnitFulfillmentFee', 'Commission'])
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        temp_model = AmzSpApi::FbaSmallAndLightApiModel.const_get(type).new
