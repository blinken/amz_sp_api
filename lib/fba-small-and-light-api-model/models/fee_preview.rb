...
module AmzSpApi::FbaSmallAndLightApiModel
  ...
  class FeePreview
    ...
    def self.swagger_types
      {
        :'asin' => :'String',
        :'price' => :'MoneyType',
        :'fee_breakdown' => :'Array<FeeLineItem>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'feeBreakdown')
        if (value = attributes[:'feeBreakdown']).is_a?(Array)
          self.fee_breakdown = value
        end
      end

      if attributes.has_key?(:'totalFees')
        self.total_fees = attributes[:'totalFees']
      end
    ...
    def hash
      [asin, price, fee_breakdown, total_fees, errors].hash
    end
