...
module AmzSpApi::FbaSmallAndLightApiModel
  class SmallAndLightApi
    ...
    def delete_small_and_light_enrollment_by_seller_sku_with_http_info(seller_sku, marketplace_ids, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'seller_sku' when calling SmallAndLightApi.delete_small_and_light_enrollment_by_seller_sku" if seller_sku.nil?
      # verify the required parameter 'marketplace_ids' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_ids' when calling SmallAndLightApi.delete_small_and_light_enrollment_by_seller_sku" if marketplace_ids.nil?
      # resource path
      local_var_path = "/fba/smallAndLight/v1/enrollments/{sellerSKU}".sub('{format}','json').sub('{' + 'sellerSKU' + '}', seller_sku.to_s)
    ...
    def get_small_and_light_eligibility_by_seller_sku_with_http_info(seller_sku, marketplace_ids, opts = {})
      ...
      # verify the required parameter 'seller_sku' is set
      fail ArgumentError, "Missing the required parameter 'seller_sku' when calling SmallAndLightApi.get_small_and_light_eligibility_by_seller_sku" if seller_sku.nil?
      # verify the required parameter 'marketplace_ids' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_ids' when calling SmallAndLightApi.get_small_and_light_eligibility_by_seller_sku" if marketplace_ids.nil?
      # resource path
      local_var_path = "/fba/smallAndLight/v1/eligibilities/{sellerSKU}".sub('{format}','json').sub('{' + 'sellerSKU' + '}', seller_sku.to_s)
    ...
    def get_small_and_light_enrollment_by_seller_sku_with_http_info(seller_sku, marketplace_ids, opts = {})
      ...
      # verify the required parameter 'seller_sku' is set
      fail ArgumentError, "Missing the required parameter 'seller_sku' when calling SmallAndLightApi.get_small_and_light_enrollment_by_seller_sku" if seller_sku.nil?
      # verify the required parameter 'marketplace_ids' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_ids' when calling SmallAndLightApi.get_small_and_light_enrollment_by_seller_sku" if marketplace_ids.nil?
      # resource path
      local_var_path = "/fba/smallAndLight/v1/enrollments/{sellerSKU}".sub('{format}','json').sub('{' + 'sellerSKU' + '}', seller_sku.to_s)
    ...
    def get_small_and_light_fee_preview_with_http_info(body, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'body' when calling SmallAndLightApi.get_small_and_light_fee_preview" if body.nil?
      # resource path
      local_var_path = "/fba/smallAndLight/v1/feePreviews".sub('{format}','json')
    ...
    def put_small_and_light_enrollment_by_seller_sku_with_http_info(seller_sku, marketplace_ids, opts = {})
      ...
      # verify the required parameter 'seller_sku' is set
      fail ArgumentError, "Missing the required parameter 'seller_sku' when calling SmallAndLightApi.put_small_and_light_enrollment_by_seller_sku" if seller_sku.nil?
      # verify the required parameter 'marketplace_ids' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_ids' when calling SmallAndLightApi.put_small_and_light_enrollment_by_seller_sku" if marketplace_ids.nil?
      # resource path
      local_var_path = "/fba/smallAndLight/v1/enrollments/{sellerSKU}".sub('{format}','json').sub('{' + 'sellerSKU' + '}', seller_sku.to_s)
