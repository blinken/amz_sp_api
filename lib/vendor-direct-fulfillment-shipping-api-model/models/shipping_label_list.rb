...
module AmzSpApi::VendorDirectFulfillmentShippingApiModel
  ...
  class ShippingLabelList
    ...
    def self.swagger_types
      {
        :'pagination' => :'Pagination',
        :'shipping_labels' => :'Array<ShippingLabel>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'shippingLabels')
        if (value = attributes[:'shippingLabels']).is_a?(Array)
          self.shipping_labels = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          shipping_labels == o.shipping_labels
    end
    ...
    def hash
      [pagination, shipping_labels].hash
    end
