...
module AmzSpApi::VendorDirectFulfillmentShippingApiModel
  class ShipmentStatusUpdate
    ...
    attr_accessor :status_update_details
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'statusUpdateDetails')
        self.status_update_details = attributes[:'statusUpdateDetails']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @status_update_details.nil?
        invalid_properties.push('invalid value for "status_update_details", status_update_details cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @status_update_details.nil?
      true
    end
    ...
    def hash
      [purchase_order_number, selling_party, ship_from_party, status_update_details].hash
    end
