...
module AmzSpApi::VendorDirectFulfillmentShippingApiModel
  ...
  class LabelData
    ...
    attr_accessor :ship_method_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'packageIdentifier')
        self.package_identifier = attributes[:'packageIdentifier']
      end
      ...
      if attributes.has_key?(:'shipMethodName')
        self.ship_method_name = attributes[:'shipMethodName']
      end
