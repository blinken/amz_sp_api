...
module AmzSpApi::VendorDirectFulfillmentShippingApiModel
  ...
  class CustomerInvoiceList
    ...
    def self.swagger_types
      {
        :'pagination' => :'Pagination',
        :'customer_invoices' => :'Array<CustomerInvoice>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'customerInvoices')
        if (value = attributes[:'customerInvoices']).is_a?(Array)
          self.customer_invoices = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          customer_invoices == o.customer_invoices
    end
    ...
    def hash
      [pagination, customer_invoices].hash
    end
