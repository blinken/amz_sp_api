...
module AmzSpApi::VendorDirectFulfillmentShippingApiModel
  ...
  class PackedItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'packedQuantity')
        self.packed_quantity = attributes[:'packedQuantity']
      end
    ...
    def hash
      [item_sequence_number, buyer_product_identifier, vendor_product_identifier, packed_quantity].hash
    end
