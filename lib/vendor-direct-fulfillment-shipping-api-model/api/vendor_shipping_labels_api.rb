  ...
  class VendorShippingLabelsApi
    ...
    def get_shipping_labels_with_http_info(created_after, created_before, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 100
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling VendorShippingLabelsApi.get_shipping_labels, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling VendorShippingLabelsApi.get_shipping_labels, must be greater than or equal to 1.'
      end
