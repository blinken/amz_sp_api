...
module AmzSpApi::VendorDirectFulfillmentShippingApiModel
  class CustomerInvoicesApi
    ...
    def get_customer_invoice_with_http_info(purchase_order_number, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'purchase_order_number' when calling CustomerInvoicesApi.get_customer_invoice" if purchase_order_number.nil?
      ...
      # resource path
      local_var_path = "/vendor/directFulfillment/shipping/v1/customerInvoices/{purchaseOrderNumber}".sub('{format}','json').sub('{' + 'purchaseOrderNumber' + '}', purchase_order_number.to_s)
    ...
    def get_customer_invoices_with_http_info(created_after, created_before, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'created_after' when calling CustomerInvoicesApi.get_customer_invoices" if created_after.nil?
      # verify the required parameter 'created_before' is set
      fail ArgumentError, "Missing the required parameter 'created_before' when calling CustomerInvoicesApi.get_customer_invoices" if created_before.nil?
      if !opts[:'limit'].nil? && opts[:'limit'] > 100.0
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling CustomerInvoicesApi.get_customer_invoices, must be smaller than or equal to 100.0.'
      end

      if !opts[:'limit'].nil? && opts[:'limit'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling CustomerInvoicesApi.get_customer_invoices, must be greater than or equal to 1.0.'
      end
      ...
      # resource path
      local_var_path = "/vendor/directFulfillment/shipping/v1/customerInvoices".sub('{format}','json')
