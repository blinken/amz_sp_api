...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingApiModel::PartyIdentification
...
describe 'PartyIdentification' do
  ...
  describe 'test an instance of PartyIdentification' do
    it 'should create an instact of PartyIdentification' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingApiModel::PartyIdentification)
    end
  end
