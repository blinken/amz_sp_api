...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingApiModel::ShipmentStatusUpdate
...
describe 'ShipmentStatusUpdate' do
  ...
  describe 'test an instance of ShipmentStatusUpdate' do
    it 'should create an instact of ShipmentStatusUpdate' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingApiModel::ShipmentStatusUpdate)
    end
  end
