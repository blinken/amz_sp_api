...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingApiModel::ShippingLabelRequest
...
describe 'ShippingLabelRequest' do
  ...
  describe 'test an instance of ShippingLabelRequest' do
    it 'should create an instact of ShippingLabelRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingApiModel::ShippingLabelRequest)
    end
  end
