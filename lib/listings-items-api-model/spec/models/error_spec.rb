...
# Unit tests for AmzSpApi::ListingsItemsApiModel::Error
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Error' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItemsApiModel::Error.new
  end
  ...
  describe 'test an instance of Error' do
    it 'should create an instact of Error' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItemsApiModel::Error)
    end
  end
