...
# Unit tests for AmzSpApi::ListingsItemsApiModel::Points
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Points' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItemsApiModel::Points.new
  end
  ...
  describe 'test an instance of Points' do
    it 'should create an instact of Points' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItemsApiModel::Points)
    end
  end
