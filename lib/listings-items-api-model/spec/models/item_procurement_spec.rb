...
# Unit tests for AmzSpApi::ListingsItemsApiModel::ItemProcurement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemProcurement' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItemsApiModel::ItemProcurement.new
  end
  ...
  describe 'test an instance of ItemProcurement' do
    it 'should create an instact of ItemProcurement' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItemsApiModel::ItemProcurement)
    end
  end
