...
module AmzSpApi::ListingsItemsApiModel
  class ListingsApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :issue_locale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale.
    # @return [Array<(ListingsItemSubmissionResponse, Fixnum, Hash)>] ListingsItemSubmissionResponse data, response status code and response headers
    def delete_listings_item_with_http_info(seller_id, sku, marketplace_ids, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'seller_id' when calling ListingsApi.delete_listings_item" if seller_id.nil?
      # verify the required parameter 'sku' is set
      fail ArgumentError, "Missing the required parameter 'sku' when calling ListingsApi.delete_listings_item" if sku.nil?
      # verify the required parameter 'marketplace_ids' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_ids' when calling ListingsApi.delete_listings_item" if marketplace_ids.nil?
      # resource path
      local_var_path = "/listings/2021-08-01/items/{sellerId}/{sku}".sub('{format}','json').sub('{' + 'sellerId' + '}', seller_id.to_s).sub('{' + 'sku' + '}', sku.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'ListingsItemSubmissionResponse')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :issue_locale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale.
    # @option opts [Array<String>] :included_data A comma-delimited list of data sets to include in the response. Default: summaries. (default to summaries)
    # @return [Item]
    ...
    def get_listings_item_with_http_info(seller_id, sku, marketplace_ids, opts = {})
      ...
      # verify the required parameter 'seller_id' is set
      fail ArgumentError, "Missing the required parameter 'seller_id' when calling ListingsApi.get_listings_item" if seller_id.nil?
      # verify the required parameter 'sku' is set
      fail ArgumentError, "Missing the required parameter 'sku' when calling ListingsApi.get_listings_item" if sku.nil?
      # verify the required parameter 'marketplace_ids' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_ids' when calling ListingsApi.get_listings_item" if marketplace_ids.nil?
      if opts[:'included_data'] && !['summaries', 'attributes', 'issues', 'offers', 'fulfillmentAvailability', 'procurement'].include?(opts[:'included_data'])
        fail ArgumentError, 'invalid value for "included_data", must be one of summaries, attributes, issues, offers, fulfillmentAvailability, procurement'
      end
      # resource path
      local_var_path = "/listings/2021-08-01/items/{sellerId}/{sku}".sub('{format}','json').sub('{' + 'sellerId' + '}', seller_id.to_s).sub('{' + 'sku' + '}', sku.to_s)
    ...
    # @option opts [String] :issue_locale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale.
    # @return [ListingsItemSubmissionResponse]
    def patch_listings_item(seller_id, sku, marketplace_ids, body, opts = {})
      data, _status_code, _headers = patch_listings_item_with_http_info(seller_id, sku, marketplace_ids, body, opts)
      return data
    end
    ...
    # @option opts [String] :issue_locale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale.
    # @return [Array<(ListingsItemSubmissionResponse, Fixnum, Hash)>] ListingsItemSubmissionResponse data, response status code and response headers
    def patch_listings_item_with_http_info(seller_id, sku, marketplace_ids, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ListingsApi.patch_listings_item ..."
      end
      # verify the required parameter 'seller_id' is set
      fail ArgumentError, "Missing the required parameter 'seller_id' when calling ListingsApi.patch_listings_item" if seller_id.nil?
      # verify the required parameter 'sku' is set
      fail ArgumentError, "Missing the required parameter 'sku' when calling ListingsApi.patch_listings_item" if sku.nil?
      # verify the required parameter 'marketplace_ids' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_ids' when calling ListingsApi.patch_listings_item" if marketplace_ids.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling ListingsApi.patch_listings_item" if body.nil?
      # resource path
      local_var_path = "/listings/2021-08-01/items/{sellerId}/{sku}".sub('{format}','json').sub('{' + 'sellerId' + '}', seller_id.to_s).sub('{' + 'sku' + '}', sku.to_s)
    ...
    # @option opts [String] :issue_locale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale.
    # @return [ListingsItemSubmissionResponse]
    def put_listings_item(seller_id, sku, marketplace_ids, body, opts = {})
      data, _status_code, _headers = put_listings_item_with_http_info(seller_id, sku, marketplace_ids, body, opts)
      return data
    end
    ...
    # @option opts [String] :issue_locale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale.
    # @return [Array<(ListingsItemSubmissionResponse, Fixnum, Hash)>] ListingsItemSubmissionResponse data, response status code and response headers
    def put_listings_item_with_http_info(seller_id, sku, marketplace_ids, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ListingsApi.put_listings_item ..."
      end
      # verify the required parameter 'seller_id' is set
      fail ArgumentError, "Missing the required parameter 'seller_id' when calling ListingsApi.put_listings_item" if seller_id.nil?
      # verify the required parameter 'sku' is set
      fail ArgumentError, "Missing the required parameter 'sku' when calling ListingsApi.put_listings_item" if sku.nil?
      # verify the required parameter 'marketplace_ids' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_ids' when calling ListingsApi.put_listings_item" if marketplace_ids.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling ListingsApi.put_listings_item" if body.nil?
      # resource path
      local_var_path = "/listings/2021-08-01/items/{sellerId}/{sku}".sub('{format}','json').sub('{' + 'sellerId' + '}', seller_id.to_s).sub('{' + 'sku' + '}', sku.to_s)
