...
module AmzSpApi::ListingsItemsApiModel
  ...
  class Item
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'summaries')
      ...
      if attributes.has_key?(:'fulfillmentAvailability')
        if (value = attributes[:'fulfillmentAvailability']).is_a?(Array)
          self.fulfillment_availability = value
        end
      end

      if attributes.has_key?(:'procurement')
        self.procurement = attributes[:'procurement']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          issues == o.issues &&
          offers == o.offers &&
          fulfillment_availability == o.fulfillment_availability &&
    ...
    def hash
      [sku, summaries, attributes, issues, offers, fulfillment_availability, procurement].hash
    end
