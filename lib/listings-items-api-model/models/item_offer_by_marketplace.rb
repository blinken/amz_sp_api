...
module AmzSpApi::ListingsItemsApiModel
  ...
  class ItemOfferByMarketplace
    ...
    def valid?
      ...
      offer_type_validator = EnumAttributeValidator.new('String', ["B2C", "B2B"])
    ...
    def offer_type=(offer_type)
      validator = EnumAttributeValidator.new('String', ["B2C", "B2B"])
    ...
    def hash
      [marketplace_id, offer_type, price, points].hash
    end
