...
module AmzSpApi::ListingsItemsApiModel
  ...
  class ListingsItemSubmissionResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'submissionId')
        self.submission_id = attributes[:'submissionId']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['ACCEPTED', 'INVALID'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['ACCEPTED', 'INVALID'])
