...
module AmzSpApi::ListingsItemsApiModel
  ...
  class FulfillmentAvailability
    ...
    attr_accessor :fulfillment_channel_code
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fulfillmentChannelCode')
        self.fulfillment_channel_code = attributes[:'fulfillmentChannelCode']
      end
    ...
    def list_invalid_properties
      ...
      if !@quantity.nil? && @quantity < 0.0
        invalid_properties.push("invalid value for 'quantity', must be greater than or equal to 0.0.")
      end
    ...
    def valid?
      return false if @fulfillment_channel_code.nil?
      return false if !@quantity.nil? && @quantity < 0.0
      return true
    end
    ...
    def quantity=(quantity)
      ...
      if !quantity.nil? && quantity < 0.0
        fail ArgumentError, "invalid value for 'quantity', must be greater than or equal to 0.0."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          fulfillment_channel_code == o.fulfillment_channel_code &&
          quantity == o.quantity
    end
    ...
    def hash
      [fulfillment_channel_code, quantity].hash
    end
