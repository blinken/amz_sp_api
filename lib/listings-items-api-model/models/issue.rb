...
module AmzSpApi::ListingsItemsApiModel
  ...
  class Issue
    ...
    def valid?
      ...
      severity_validator = EnumAttributeValidator.new('String', ['ERROR', 'WARNING', 'INFO'])
    ...
    def severity=(severity)
      validator = EnumAttributeValidator.new('String', ['ERROR', 'WARNING', 'INFO'])
    ...
    def hash
      [code, message, severity, attribute_names].hash
    end
