...
module AmzSpApi::FbaInventoryApiModel
  class FbaInventoryApi
    ...
    # @option opts [Array<String>] :seller_skus A list of seller SKUs for which to return inventory summaries. You may specify up to 50 SKUs.
    # @option opts [String] :next_token String token returned in the response of your previous request.
    # @return [Array<(GetInventorySummariesResponse, Fixnum, Hash)>] GetInventorySummariesResponse data, response status code and response headers
    def get_inventory_summaries_with_http_info(granularity_type, granularity_id, marketplace_ids, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'granularity_type' when calling FbaInventoryApi.get_inventory_summaries" if granularity_type.nil?
      # verify enum value
      unless ['Marketplace'].include?(granularity_type)
      ...
      fail ArgumentError, "Missing the required parameter 'granularity_id' when calling FbaInventoryApi.get_inventory_summaries" if granularity_id.nil?
      # verify the required parameter 'marketplace_ids' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_ids' when calling FbaInventoryApi.get_inventory_summaries" if marketplace_ids.nil?
      # resource path
      local_var_path = "/fba/inventory/v1/summaries".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GetInventorySummariesResponse')
      if @api_client.config.debugging
