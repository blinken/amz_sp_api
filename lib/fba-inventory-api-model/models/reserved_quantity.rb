...
module AmzSpApi::FbaInventoryApiModel
  ...
  class ReservedQuantity
    ...
    def self.swagger_types
      {
        ...
        :'fc_processing_quantity' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'totalReservedQuantity')
        self.total_reserved_quantity = attributes[:'totalReservedQuantity']
      end

      if attributes.has_key?(:'pendingCustomerOrderQuantity')
        self.pending_customer_order_quantity = attributes[:'pendingCustomerOrderQuantity']
      end

      if attributes.has_key?(:'pendingTransshipmentQuantity')
        self.pending_transshipment_quantity = attributes[:'pendingTransshipmentQuantity']
      end

      if attributes.has_key?(:'fcProcessingQuantity')
        self.fc_processing_quantity = attributes[:'fcProcessingQuantity']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          total_reserved_quantity == o.total_reserved_quantity &&
          pending_customer_order_quantity == o.pending_customer_order_quantity &&
          pending_transshipment_quantity == o.pending_transshipment_quantity &&
          fc_processing_quantity == o.fc_processing_quantity
    end
