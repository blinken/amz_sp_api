...
module AmzSpApi::FbaInventoryApiModel
  ...
  class Granularity
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'granularityType')
        self.granularity_type = attributes[:'granularityType']
      end

      if attributes.has_key?(:'granularityId')
        self.granularity_id = attributes[:'granularityId']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          granularity_type == o.granularity_type &&
          granularity_id == o.granularity_id
    end
    ...
    def hash
      [granularity_type, granularity_id].hash
    end
