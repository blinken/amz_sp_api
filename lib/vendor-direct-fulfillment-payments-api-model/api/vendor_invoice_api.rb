...
module AmzSpApi::VendorDirectFulfillmentPaymentsApiModel
  class VendorInvoiceApi
    ...
    def submit_invoice_with_http_info(body, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'body' when calling VendorInvoiceApi.submit_invoice" if body.nil?
      # resource path
      local_var_path = "/vendor/directFulfillment/payments/v1/invoices".sub('{format}','json')
