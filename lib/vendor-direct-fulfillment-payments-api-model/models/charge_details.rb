...
module AmzSpApi::VendorDirectFulfillmentPaymentsApiModel
  ...
  class ChargeDetails
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["GIFTWRAP", "FULFILLMENT", "MARKETINGINSERT", "PACKAGING", "LOADING", "FREIGHTOUT", "TAX_COLLECTED_AT_SOURCE"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["GIFTWRAP", "FULFILLMENT", "MARKETINGINSERT", "PACKAGING", "LOADING", "FREIGHTOUT", "TAX_COLLECTED_AT_SOURCE"])
    ...
    def hash
      [type, charge_amount, tax_details].hash
    end
