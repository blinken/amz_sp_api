...
# Unit tests for AmzSpApi::VendorDirectFulfillmentPaymentsApiModel::Address
...
describe 'Address' do
  ...
  describe 'test an instance of Address' do
    it 'should create an instance of Address' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentPaymentsApiModel::Address)
    end
  end
