  ...
  class VendorOrdersApi
    ...
    def get_purchase_orders_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 100
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling VendorOrdersApi.get_purchase_orders, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling VendorOrdersApi.get_purchase_orders, must be greater than or equal to 1.'
      end
    ...
    def get_purchase_orders_status_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 100
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling VendorOrdersApi.get_purchase_orders_status, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling VendorOrdersApi.get_purchase_orders_status, must be greater than or equal to 1.'
      end
