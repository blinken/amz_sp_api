...
module AmzSpApi::VendorOrdersApiModel
  ...
  class OrderListStatus
    ...
    def self.swagger_types
      {
        :'pagination' => :'Pagination',
        :'orders_status' => :'Array<OrderStatus>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ordersStatus')
        if (value = attributes[:'ordersStatus']).is_a?(Array)
          self.orders_status = value
        end
      end
