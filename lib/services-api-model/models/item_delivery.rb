...
module AmzSpApi::ServicesApiModel
  ...
  class ItemDelivery
    ...
    attr_accessor :item_delivery_promise
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'itemDeliveryPromise')
        self.item_delivery_promise = attributes[:'itemDeliveryPromise']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          item_delivery_promise == o.item_delivery_promise
    end
    ...
    def hash
      [estimated_delivery_date, item_delivery_promise].hash
    end
