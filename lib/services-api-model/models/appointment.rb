...
module AmzSpApi::ServicesApiModel
  ...
  class Appointment
    ...
    attr_accessor :assigned_technicians

    # The identifier of a rescheduled appointment.
    attr_accessor :rescheduled_appointment_id
    ...
    def self.swagger_types
      {
        ...
        :'appointment_time' => :'AppointmentTime',
        :'assigned_technicians' => :'Array<Technician>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'assignedTechnicians')
        if (value = attributes[:'assignedTechnicians']).is_a?(Array)
          self.assigned_technicians = value
        end
      end

      if attributes.has_key?(:'rescheduledAppointmentId')
        self.rescheduled_appointment_id = attributes[:'rescheduledAppointmentId']
      end

      if attributes.has_key?(:'poa')
        self.poa = attributes[:'poa']
      end
    ...
    def valid?
      appointment_status_validator = EnumAttributeValidator.new('String', ["ACTIVE", "CANCELLED", "COMPLETED"])
    ...
    def appointment_status=(appointment_status)
      validator = EnumAttributeValidator.new('String', ["ACTIVE", "CANCELLED", "COMPLETED"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          assigned_technicians == o.assigned_technicians &&
          rescheduled_appointment_id == o.rescheduled_appointment_id &&
          poa == o.poa
    end
    ...
    def hash
      [appointment_id, appointment_status, appointment_time, assigned_technicians, rescheduled_appointment_id, poa].hash
    end
