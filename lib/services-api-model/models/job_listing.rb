...
module AmzSpApi::ServicesApiModel
  ...
  class JobListing
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'previousPageToken')
        self.previous_page_token = attributes[:'previousPageToken']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          previous_page_token == o.previous_page_token &&
          jobs == o.jobs
    end
    ...
    def hash
      [total_result_size, next_page_token, previous_page_token, jobs].hash
    end
