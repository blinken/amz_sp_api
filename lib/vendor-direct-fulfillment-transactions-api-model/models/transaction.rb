...
module AmzSpApi::VendorDirectFulfillmentTransactionsApiModel
  ...
  class Transaction
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['Failure', 'Processing', 'Success'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['Failure', 'Processing', 'Success'])
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        temp_model = AmzSpApi::VendorDirectFulfillmentTransactionsApiModel.const_get(type).new
