...
module AmzSpApi::VendorDirectFulfillmentTransactionsApiModel
  class VendorTransactionApi
    ...
    def get_transaction_status_with_http_info(transaction_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'transaction_id' when calling VendorTransactionApi.get_transaction_status" if transaction_id.nil?
      # resource path
      local_var_path = "/vendor/directFulfillment/transactions/v1/transactions/{transactionId}".sub('{format}','json').sub('{' + 'transactionId' + '}', transaction_id.to_s)
