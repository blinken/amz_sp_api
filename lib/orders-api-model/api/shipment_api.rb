...
module AmzSpApi::OrdersApiModel
  class ShipmentApi
    ...
    def update_shipment_status_with_http_info(order_id, payload, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'order_id' when calling ShipmentApi.update_shipment_status" if order_id.nil?
      # verify the required parameter 'payload' is set
      fail ArgumentError, "Missing the required parameter 'payload' when calling ShipmentApi.update_shipment_status" if payload.nil?
      # resource path
      local_var_path = "/orders/v0/orders/{orderId}/shipment".sub('{format}','json').sub('{' + 'orderId' + '}', order_id.to_s)
