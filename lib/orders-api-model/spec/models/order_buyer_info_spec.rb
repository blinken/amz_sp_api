...
# Unit tests for AmzSpApi::OrdersApiModel::OrderBuyerInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderBuyerInfo' do
  before do
  ...
  describe 'test an instance of OrderBuyerInfo' do
    it 'should create an instance of OrderBuyerInfo' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModel::OrderBuyerInfo)
    end
  end
