...
# Unit tests for AmzSpApi::OrdersApiModel::OrdersVApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrdersVApi' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModel::OrdersVApi.new
  end
  ...
  describe 'test an instance of OrdersVApi' do
    it 'should create an instact of OrdersVApi' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModel::OrdersVApi)
    end
  end
