# AmzSpApi::OrdersApiModel::OrdersVApi

All URIs are relative to *https://sellingpartnerapi-na.amazon.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_order**](OrdersVApi.md#get_order) | **GET** /orders/v0/orders/{orderId} | 
[**get_order_address**](OrdersVApi.md#get_order_address) | **GET** /orders/v0/orders/{orderId}/address | 
[**get_order_buyer_info**](OrdersVApi.md#get_order_buyer_info) | **GET** /orders/v0/orders/{orderId}/buyerInfo | 
[**get_order_items**](OrdersVApi.md#get_order_items) | **GET** /orders/v0/orders/{orderId}/orderItems | 
[**get_order_items_buyer_info**](OrdersVApi.md#get_order_items_buyer_info) | **GET** /orders/v0/orders/{orderId}/orderItems/buyerInfo | 
[**get_orders**](OrdersVApi.md#get_orders) | **GET** /orders/v0/orders | 
...
begin
  ...
  puts "Exception when calling OrdersVApi->get_order_address: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling OrdersVApi->get_order_buyer_info: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling OrdersVApi->get_order_items: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling OrdersVApi->get_order_items_buyer_info: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling OrdersVApi->get_orders: #{e}"
end
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **marketplace_ids** | [**Array&lt;String&gt;**](String.md)| A list of MarketplaceId values. Used to select orders that were placed in the specified marketplaces.  See the [Selling Partner API Developer Guide](https://github.com/amzn/selling-partner-api-docs/blob/main/guides/en-US/developer-guide/SellingPartnerApiDeveloperGuide.md#marketplaceid-values) for a complete list of marketplaceId values. | 
