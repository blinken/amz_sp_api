...
module AmzSpApi::FulfillmentOutboundApiModel
  ...
  class GetFeatureSkuResult
    ...
    attr_accessor :ineligible_reasons
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isEligible')
        self.is_eligible = attributes[:'isEligible']
      end

      if attributes.has_key?(:'ineligibleReasons')
        if (value = attributes[:'ineligibleReasons']).is_a?(Array)
          self.ineligible_reasons = value
        end
      end

      if attributes.has_key?(:'skuInfo')
        self.sku_info = attributes[:'skuInfo']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @is_eligible.nil?
        invalid_properties.push('invalid value for "is_eligible", is_eligible cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_eligible.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ineligible_reasons == o.ineligible_reasons &&
          sku_info == o.sku_info
    end
    ...
    def hash
      [marketplace_id, feature_name, is_eligible, ineligible_reasons, sku_info].hash
    end
