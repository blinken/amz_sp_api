...
module AmzSpApi::FulfillmentOutboundApiModel
  ...
  class InvalidReturnItem
    ...
    attr_accessor :invalid_item_reason
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'invalidItemReason')
        self.invalid_item_reason = attributes[:'invalidItemReason']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @invalid_item_reason.nil?
        invalid_properties.push('invalid value for "invalid_item_reason", invalid_item_reason cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @invalid_item_reason.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          invalid_item_reason == o.invalid_item_reason
    end
    ...
    def hash
      [seller_return_item_id, seller_fulfillment_order_item_id, invalid_item_reason].hash
    end
