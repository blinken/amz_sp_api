  ...
  class CreateFulfillmentOrderRequest
    ...
    def list_invalid_properties
      ...
      if @seller_fulfillment_order_id.to_s.length > 40
        invalid_properties.push("invalid value for 'seller_fulfillment_order_id', the character length must be smaller than or equal to 40.")
      end
      ...
      if @displayable_order_id.to_s.length > 40
      ...
      if @displayable_order_comment.to_s.length > 1000
    ...
    def valid?
      ...
      return false if @seller_fulfillment_order_id.to_s.length > 40
      return false if @displayable_order_id.nil?
      return false if @displayable_order_id.to_s.length > 40
      return false if @displayable_order_date.nil?
      return false if @displayable_order_comment.nil?
      return false if @displayable_order_comment.to_s.length > 1000
    ...
    # @param [Object] seller_fulfillment_order_id Value to be assigned
    def seller_fulfillment_order_id=(seller_fulfillment_order_id)
      if seller_fulfillment_order_id.nil?
        fail ArgumentError, "seller_fulfillment_order_id cannot be nil"
      end

      if seller_fulfillment_order_id.to_s.length > 40
        fail ArgumentError, "invalid value for 'seller_fulfillment_order_id', the character length must be smaller than or equal to 40."
      end
    ...
    def displayable_order_id=(displayable_order_id)
      if displayable_order_id.nil?
        fail ArgumentError, "displayable_order_id cannot be nil"
      end
    ...
    def displayable_order_comment=(displayable_order_comment)
      if displayable_order_comment.nil?
        fail ArgumentError, "displayable_order_comment cannot be nil"
      end
    ...
    def hash
      [marketplace_id, seller_fulfillment_order_id, displayable_order_id, displayable_order_date, displayable_order_comment, shipping_speed_category, delivery_window, destination_address, fulfillment_action, fulfillment_policy, cod_settings, ship_from_country_code, notification_emails, feature_constraints, items].hash
    end
