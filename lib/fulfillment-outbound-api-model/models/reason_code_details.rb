...
module AmzSpApi::FulfillmentOutboundApiModel
  ...
  class ReasonCodeDetails
    ...
    attr_accessor :translated_description
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'translatedDescription')
        self.translated_description = attributes[:'translatedDescription']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          translated_description == o.translated_description
    end
    ...
    def hash
      [return_reason_code, description, translated_description].hash
    end
