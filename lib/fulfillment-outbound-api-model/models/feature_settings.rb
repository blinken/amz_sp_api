...
module AmzSpApi::FulfillmentOutboundApiModel
  ...
  class FeatureSettings
    ...
    attr_accessor :feature_fulfillment_policy
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'featureFulfillmentPolicy')
        self.feature_fulfillment_policy = attributes[:'featureFulfillmentPolicy']
      end
    ...
    def valid?
      feature_fulfillment_policy_validator = EnumAttributeValidator.new('String', ["Required", "NotRequired"])
      return false unless feature_fulfillment_policy_validator.valid?(@feature_fulfillment_policy)
      return true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] feature_fulfillment_policy Object to be assigned
    def feature_fulfillment_policy=(feature_fulfillment_policy)
      validator = EnumAttributeValidator.new('String', ["Required", "NotRequired"])
      unless validator.valid?(feature_fulfillment_policy)
        fail ArgumentError, "invalid value for 'feature_fulfillment_policy', must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          feature_fulfillment_policy == o.feature_fulfillment_policy
    end
