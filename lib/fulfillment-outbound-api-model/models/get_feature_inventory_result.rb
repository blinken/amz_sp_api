...
module AmzSpApi::FulfillmentOutboundApiModel
  ...
  class GetFeatureInventoryResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'featureSkus')
        if (value = attributes[:'featureSkus']).is_a?(Array)
