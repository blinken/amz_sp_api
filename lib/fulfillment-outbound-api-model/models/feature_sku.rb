...
module AmzSpApi::FulfillmentOutboundApiModel
  ...
  class FeatureSku
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'skuCount')
        self.sku_count = attributes[:'skuCount']
      end

      if attributes.has_key?(:'overlappingSkus')
        if (value = attributes[:'overlappingSkus']).is_a?(Array)
          self.overlapping_skus = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          overlapping_skus == o.overlapping_skus
    end
    ...
    def hash
      [seller_sku, fn_sku, asin, sku_count, overlapping_skus].hash
    end
