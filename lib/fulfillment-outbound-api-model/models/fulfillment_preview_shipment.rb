...
module AmzSpApi::FulfillmentOutboundApiModel
  ...
  class FulfillmentPreviewShipment
    ...
    attr_accessor :fulfillment_preview_items
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'earliestArrivalDate')
        self.earliest_arrival_date = attributes[:'earliestArrivalDate']
      end

      if attributes.has_key?(:'latestArrivalDate')
        self.latest_arrival_date = attributes[:'latestArrivalDate']
      end
      ...
      if attributes.has_key?(:'fulfillmentPreviewItems')
        self.fulfillment_preview_items = attributes[:'fulfillmentPreviewItems']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @fulfillment_preview_items.nil?
        invalid_properties.push('invalid value for "fulfillment_preview_items", fulfillment_preview_items cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          earliest_arrival_date == o.earliest_arrival_date &&
          latest_arrival_date == o.latest_arrival_date &&
          shipping_notes == o.shipping_notes &&
          fulfillment_preview_items == o.fulfillment_preview_items
    end
