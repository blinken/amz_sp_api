...
module AmzSpApi::FulfillmentOutboundApiModel
  class ListAllFulfillmentOrdersResult
    ...
    attr_accessor :fulfillment_orders
    ...
    def self.swagger_types
      {
        :'next_token' => :'String',
        :'fulfillment_orders' => :'Array<FulfillmentOrder>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fulfillmentOrders')
        if (value = attributes[:'fulfillmentOrders']).is_a?(Array)
          self.fulfillment_orders = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fulfillment_orders == o.fulfillment_orders
    end
    ...
    def hash
      [next_token, fulfillment_orders].hash
    end
