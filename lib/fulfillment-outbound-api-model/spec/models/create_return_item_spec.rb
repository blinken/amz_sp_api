...
# Unit tests for AmzSpApi::FulfillmentOutboundApiModel::CreateReturnItem
...
describe 'CreateReturnItem' do
  ...
  describe 'test an instance of CreateReturnItem' do
    it 'should create an instact of CreateReturnItem' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentOutboundApiModel::CreateReturnItem)
    end
  end
