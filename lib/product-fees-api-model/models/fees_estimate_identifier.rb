...
module AmzSpApi::ProductFeesApiModel
  ...
  class FeesEstimateIdentifier
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdValue')
        self.id_value = attributes[:'IdValue']
      end
      ...
      if attributes.has_key?(:'SellerInputIdentifier')
        self.seller_input_identifier = attributes[:'SellerInputIdentifier']
      end
