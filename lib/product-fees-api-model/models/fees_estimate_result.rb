...
module AmzSpApi::ProductFeesApiModel
  ...
  class FeesEstimateResult
    ...
    attr_accessor :fees_estimate_identifier

    # The total estimated fees for an item and a list of details.
    attr_accessor :fees_estimate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'FeesEstimateIdentifier')
        self.fees_estimate_identifier = attributes[:'FeesEstimateIdentifier']
      end

      if attributes.has_key?(:'FeesEstimate')
        self.fees_estimate = attributes[:'FeesEstimate']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          status == o.status &&
          fees_estimate_identifier == o.fees_estimate_identifier &&
    ...
    def hash
      [status, fees_estimate_identifier, fees_estimate, error].hash
    end
