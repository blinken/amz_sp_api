...
module AmzSpApi::ProductFeesApiModel
  ...
  class GetMyFeesEstimateRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'FeesEstimateRequest')
        self.fees_estimate_request = attributes[:'FeesEstimateRequest']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          fees_estimate_request == o.fees_estimate_request
    end
