...
# Unit tests for AmzSpApi::AplusContentApiModel::ImageDimensions
...
describe 'ImageDimensions' do
  ...
  describe 'test an instance of ImageDimensions' do
    it 'should create an instact of ImageDimensions' do
      expect(@instance).to be_instance_of(AmzSpApi::AplusContentApiModel::ImageDimensions)
    end
  end
