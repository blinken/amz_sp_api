...
module AmzSpApi::AplusContentApiModel
  ...
  class ContentMetadata
    ...
    def list_invalid_properties
      ...
      if @badge_set.nil?
        invalid_properties.push('invalid value for "badge_set", badge_set cannot be nil.')
      end
    ...
    def hash
      [name, marketplace_id, status, badge_set, update_time].hash
    end
