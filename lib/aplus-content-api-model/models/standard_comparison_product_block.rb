...
module AmzSpApi::AplusContentApiModel
  ...
  class StandardComparisonProductBlock
    ...
    def list_invalid_properties
      ...
      if @position > 6
        invalid_properties.push('invalid value for "position", must be smaller than or equal to 6.')
      end
    ...
    def position=(position)
      ...
      if position > 6
        fail ArgumentError, 'invalid value for "position", must be smaller than or equal to 6.'
      end
