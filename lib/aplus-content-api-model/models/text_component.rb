...
module AmzSpApi::AplusContentApiModel
  ...
  class TextComponent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'decoratorSet')
        self.decorator_set = attributes[:'decoratorSet']
      end
    ...
    def valid?
      ...
      return false if @value.to_s.length > 10000
