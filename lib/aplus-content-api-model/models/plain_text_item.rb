...
module AmzSpApi::AplusContentApiModel
  ...
  class PlainTextItem
    ...
    def list_invalid_properties
      ...
      if @position > 100.0
        invalid_properties.push("invalid value for 'position', must be smaller than or equal to 100.0.")
      end
    ...
    def valid?
      ...
      return false if @position > 100.0
    ...
    def position=(position)
      ...
      if position > 100.0
        fail ArgumentError, "invalid value for 'position', must be smaller than or equal to 100.0."
      end
