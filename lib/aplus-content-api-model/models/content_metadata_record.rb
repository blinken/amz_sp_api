...
module AmzSpApi::AplusContentApiModel
  ...
  class ContentMetadataRecord
    ...
    def list_invalid_properties
      ...
      if @content_metadata.nil?
        invalid_properties.push('invalid value for "content_metadata", content_metadata cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @content_metadata.nil?
      true
    end
    ...
    def hash
      [content_reference_key, content_metadata].hash
    end
