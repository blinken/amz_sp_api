...
module AmzSpApi::AplusContentApiModel
  ...
  class ContentModule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'contentModuleType')
        self.content_module_type = attributes[:'contentModuleType']
      end

      if attributes.has_key?(:'standardCompanyLogo')
        self.standard_company_logo = attributes[:'standardCompanyLogo']
      end

      if attributes.has_key?(:'standardComparisonTable')
        self.standard_comparison_table = attributes[:'standardComparisonTable']
      end

      if attributes.has_key?(:'standardFourImageText')
        self.standard_four_image_text = attributes[:'standardFourImageText']
      end

      if attributes.has_key?(:'standardFourImageTextQuadrant')
        self.standard_four_image_text_quadrant = attributes[:'standardFourImageTextQuadrant']
      end

      if attributes.has_key?(:'standardHeaderImageText')
        self.standard_header_image_text = attributes[:'standardHeaderImageText']
      end

      if attributes.has_key?(:'standardImageSidebar')
        self.standard_image_sidebar = attributes[:'standardImageSidebar']
      end

      if attributes.has_key?(:'standardImageTextOverlay')
        self.standard_image_text_overlay = attributes[:'standardImageTextOverlay']
      end

      if attributes.has_key?(:'standardMultipleImageText')
        self.standard_multiple_image_text = attributes[:'standardMultipleImageText']
      end

      if attributes.has_key?(:'standardProductDescription')
        self.standard_product_description = attributes[:'standardProductDescription']
      end

      if attributes.has_key?(:'standardSingleImageHighlights')
        self.standard_single_image_highlights = attributes[:'standardSingleImageHighlights']
      end

      if attributes.has_key?(:'standardSingleImageSpecsDetail')
        self.standard_single_image_specs_detail = attributes[:'standardSingleImageSpecsDetail']
      end

      if attributes.has_key?(:'standardSingleSideImage')
        self.standard_single_side_image = attributes[:'standardSingleSideImage']
      end

      if attributes.has_key?(:'standardTechSpecs')
        self.standard_tech_specs = attributes[:'standardTechSpecs']
      end

      if attributes.has_key?(:'standardText')
        self.standard_text = attributes[:'standardText']
      end

      if attributes.has_key?(:'standardThreeImageText')
        self.standard_three_image_text = attributes[:'standardThreeImageText']
      end
