...
module AmzSpApi::AplusContentApiModel
  class AplusContentApi
    ...
    def create_content_document_with_http_info(marketplace_id, post_content_document_request, opts = {})
      ...
      if @api_client.config.client_side_validation && marketplace_id.to_s.length < 1
      ...
      if @api_client.config.client_side_validation && post_content_document_request.nil?
        fail ArgumentError, "Missing the required parameter 'post_content_document_request' when calling AplusContentApi.create_content_document"
      end
      # resource path
    ...
    def get_content_document_with_http_info(content_reference_key, marketplace_id, included_data_set, opts = {})
      ...
      if @api_client.config.client_side_validation && content_reference_key.to_s.length < 1
      ...
      if @api_client.config.client_side_validation && included_data_set.length < 1
        fail ArgumentError, 'invalid value for "included_data_set" when calling AplusContentApi.get_content_document, number of items must be greater than or equal to 1.'
      end
    ...
    def list_content_document_asin_relations_with_http_info(content_reference_key, marketplace_id, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'included_data_set'].nil? && opts[:'included_data_set'].length < 0
        fail ArgumentError, 'invalid value for "opts[:"included_data_set"]" when calling AplusContentApi.list_content_document_asin_relations, number of items must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_token'].nil? && opts[:'page_token'].to_s.length < 1
    ...
    def post_content_document_asin_relations_with_http_info(content_reference_key, marketplace_id, post_content_document_asin_relations_request, opts = {})
      ...
      if @api_client.config.client_side_validation && post_content_document_asin_relations_request.nil?
        fail ArgumentError, "Missing the required parameter 'post_content_document_asin_relations_request' when calling AplusContentApi.post_content_document_asin_relations"
      end
      # resource path
      local_var_path = '/aplus/2020-11-01/contentDocuments/{contentReferenceKey}/asins'.sub('{' + 'contentReferenceKey' + '}', content_reference_key.to_s)
    ...
    def search_content_publish_records_with_http_info(marketplace_id, asin, opts = {})
      ...
      if @api_client.config.client_side_validation && asin.to_s.length < 10
    ...
    def update_content_document_with_http_info(content_reference_key, marketplace_id, post_content_document_request, opts = {})
      ...
      # verify the required parameter 'post_content_document_request' is set
      if @api_client.config.client_side_validation && post_content_document_request.nil?
        fail ArgumentError, "Missing the required parameter 'post_content_document_request' when calling AplusContentApi.update_content_document"
      end
      # resource path
      local_var_path = '/aplus/2020-11-01/contentDocuments/{contentReferenceKey}'.sub('{' + 'contentReferenceKey' + '}', content_reference_key.to_s)
    ...
    def validate_content_document_asin_relations_with_http_info(marketplace_id, post_content_document_request, opts = {})
      ...
      # verify the required parameter 'post_content_document_request' is set
      if @api_client.config.client_side_validation && post_content_document_request.nil?
        fail ArgumentError, "Missing the required parameter 'post_content_document_request' when calling AplusContentApi.validate_content_document_asin_relations"
      end
      # resource path
