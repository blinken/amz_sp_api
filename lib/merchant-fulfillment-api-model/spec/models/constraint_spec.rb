...
# Unit tests for AmzSpApi::MerchantFulfillmentApiModel::Constraint
...
describe 'Constraint' do
  ...
  describe 'test an instance of Constraint' do
    it 'should create an instact of Constraint' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentApiModel::Constraint)
    end
  end
