...
module AmzSpApi::MerchantFulfillmentApiModel
  ...
  class SellerInputDefinition
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Constraints')
        self.constraints = attributes[:'Constraints']
      end

      if attributes.has_key?(:'InputDisplayText')
        self.input_display_text = attributes[:'InputDisplayText']
      end

      if attributes.has_key?(:'InputTarget')
        self.input_target = attributes[:'InputTarget']
      end

      if attributes.has_key?(:'StoredValue')
        self.stored_value = attributes[:'StoredValue']
      end

      if attributes.has_key?(:'RestrictedSetValues')
        self.restricted_set_values = attributes[:'RestrictedSetValues']
      end
    end
