...
module AmzSpApi::MerchantFulfillmentApiModel
  ...
  class AdditionalSellerInput
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ValueAsString')
        self.value_as_string = attributes[:'ValueAsString']
      end

      if attributes.has_key?(:'ValueAsBoolean')
        self.value_as_boolean = attributes[:'ValueAsBoolean']
      end

      if attributes.has_key?(:'ValueAsInteger')
        self.value_as_integer = attributes[:'ValueAsInteger']
      end

      if attributes.has_key?(:'ValueAsTimestamp')
        self.value_as_timestamp = attributes[:'ValueAsTimestamp']
      end

      if attributes.has_key?(:'ValueAsAddress')
        self.value_as_address = attributes[:'ValueAsAddress']
      end

      if attributes.has_key?(:'ValueAsWeight')
        self.value_as_weight = attributes[:'ValueAsWeight']
      end

      if attributes.has_key?(:'ValueAsDimension')
        self.value_as_dimension = attributes[:'ValueAsDimension']
      end

      if attributes.has_key?(:'ValueAsCurrency')
        self.value_as_currency = attributes[:'ValueAsCurrency']
      end
