...
module AmzSpApi::MerchantFulfillmentApiModel
  ...
  class Item
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ItemWeight')
        self.item_weight = attributes[:'ItemWeight']
      end
      ...
      if attributes.has_key?(:'TransparencyCodeList')
        self.transparency_code_list = attributes[:'TransparencyCodeList']
      end

      if attributes.has_key?(:'ItemLevelSellerInputsList')
        self.item_level_seller_inputs_list = attributes[:'ItemLevelSellerInputsList']
      end
    end
