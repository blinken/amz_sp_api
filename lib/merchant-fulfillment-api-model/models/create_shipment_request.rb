...
module AmzSpApi::MerchantFulfillmentApiModel
  ...
  class CreateShipmentRequest
    ...
    attr_accessor :shipment_request_details
    ...
    attr_accessor :hazmat_type

    attr_accessor :label_format_option

    # A list of additional seller inputs required to ship this shipment.
    attr_accessor :shipment_level_seller_inputs_list
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ShipmentRequestDetails')
        self.shipment_request_details = attributes[:'ShipmentRequestDetails']
      end
      ...
      if attributes.has_key?(:'HazmatType')
        self.hazmat_type = attributes[:'HazmatType']
      end

      if attributes.has_key?(:'LabelFormatOption')
        self.label_format_option = attributes[:'LabelFormatOption']
      end

      if attributes.has_key?(:'ShipmentLevelSellerInputsList')
        self.shipment_level_seller_inputs_list = attributes[:'ShipmentLevelSellerInputsList']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @shipment_request_details.nil?
        invalid_properties.push('invalid value for "shipment_request_details", shipment_request_details cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          shipment_request_details == o.shipment_request_details &&
          shipping_service_id == o.shipping_service_id &&
          shipping_service_offer_id == o.shipping_service_offer_id &&
          hazmat_type == o.hazmat_type &&
          label_format_option == o.label_format_option &&
          shipment_level_seller_inputs_list == o.shipment_level_seller_inputs_list
    end
