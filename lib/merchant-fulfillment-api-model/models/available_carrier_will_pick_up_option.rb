...
module AmzSpApi::MerchantFulfillmentApiModel
  ...
  class AvailableCarrierWillPickUpOption
    ...
    def list_invalid_properties
      ...
      if @carrier_will_pick_up_option.nil?
        invalid_properties.push('invalid value for "carrier_will_pick_up_option", carrier_will_pick_up_option cannot be nil.')
      end
    ...
    def valid?
      return false if @carrier_will_pick_up_option.nil?
    ...
    def hash
      [carrier_will_pick_up_option, charge].hash
    end
