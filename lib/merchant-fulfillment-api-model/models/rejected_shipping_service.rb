...
module AmzSpApi::MerchantFulfillmentApiModel
  ...
  class RejectedShippingService
    ...
    attr_accessor :rejection_reason_code

    # A localized human readable description of the rejected reason.
    attr_accessor :rejection_reason_message
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RejectionReasonCode')
        self.rejection_reason_code = attributes[:'RejectionReasonCode']
      end

      if attributes.has_key?(:'RejectionReasonMessage')
        self.rejection_reason_message = attributes[:'RejectionReasonMessage']
      end
