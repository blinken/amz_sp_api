...
module AmzSpApi::VendorDirectFulfillmentInventoryApiModel
  class InventoryUpdate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isFullUpdate')
        self.is_full_update = attributes[:'isFullUpdate']
      end
    ...
    def list_invalid_properties
      ...
      if @is_full_update.nil?
        invalid_properties.push('invalid value for "is_full_update", is_full_update cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_full_update.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_full_update == o.is_full_update &&
          items == o.items
    end
    ...
    def hash
      [selling_party, is_full_update, items].hash
    end
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        temp_model = AmzSpApi::VendorDirectFulfillmentInventoryApiModel.const_get(type).new
