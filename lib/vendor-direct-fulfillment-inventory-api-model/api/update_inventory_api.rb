...
module AmzSpApi::VendorDirectFulfillmentInventoryApiModel
  class UpdateInventoryApi
    ...
    # @param warehouse_id Identifier for the warehouse for which to update inventory.
    # @param [Hash] opts the optional parameters
    # @return [Array<(SubmitInventoryUpdateResponse, Fixnum, Hash)>] SubmitInventoryUpdateResponse data, response status code and response headers
    def submit_inventory_update_with_http_info(body, warehouse_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'body' when calling UpdateInventoryApi.submit_inventory_update" if body.nil?
      # verify the required parameter 'warehouse_id' is set
      fail ArgumentError, "Missing the required parameter 'warehouse_id' when calling UpdateInventoryApi.submit_inventory_update" if warehouse_id.nil?
      # resource path
      local_var_path = "/vendor/directFulfillment/inventory/v1/warehouses/{warehouseId}/items".sub('{format}','json').sub('{' + 'warehouseId' + '}', warehouse_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'SubmitInventoryUpdateResponse')
      if @api_client.config.debugging
