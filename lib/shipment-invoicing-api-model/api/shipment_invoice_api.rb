...
module AmzSpApi::ShipmentInvoicingApiModel
  class ShipmentInvoiceApi
    ...
    def get_invoice_status_with_http_info(shipment_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling ShipmentInvoiceApi.get_invoice_status" if shipment_id.nil?
      # resource path
      local_var_path = "/fba/outbound/brazil/v0/shipments/{shipmentId}/invoice/status".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
    ...
    def get_shipment_details_with_http_info(shipment_id, opts = {})
      ...
      # verify the required parameter 'shipment_id' is set
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling ShipmentInvoiceApi.get_shipment_details" if shipment_id.nil?
      # resource path
      local_var_path = "/fba/outbound/brazil/v0/shipments/{shipmentId}".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
    ...
    def submit_invoice_with_http_info(shipment_id, body, opts = {})
      ...
      # verify the required parameter 'shipment_id' is set
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling ShipmentInvoiceApi.submit_invoice" if shipment_id.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling ShipmentInvoiceApi.submit_invoice" if body.nil?
      # resource path
      local_var_path = "/fba/outbound/brazil/v0/shipments/{shipmentId}/invoice".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
