...
# Unit tests for AmzSpApi::ShipmentInvoicingApiModel::BuyerTaxInfo
...
describe 'BuyerTaxInfo' do
  ...
  describe 'test an instance of BuyerTaxInfo' do
    it 'should create an instact of BuyerTaxInfo' do
      expect(@instance).to be_instance_of(AmzSpApi::ShipmentInvoicingApiModel::BuyerTaxInfo)
    end
  end
