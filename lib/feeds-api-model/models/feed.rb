...
module AmzSpApi::FeedsApiModel
  ...
  class Feed
    ...
    attr_accessor :result_feed_document_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'feedId')
        self.feed_id = attributes[:'feedId']
      end
      ...
      if attributes.has_key?(:'resultFeedDocumentId')
        self.result_feed_document_id = attributes[:'resultFeedDocumentId']
      end
    end
    ...
    def valid?
      ...
      processing_status_validator = EnumAttributeValidator.new('String', ['CANCELLED', 'DONE', 'FATAL', 'IN_PROGRESS', 'IN_QUEUE'])
    ...
    def processing_status=(processing_status)
      validator = EnumAttributeValidator.new('String', ['CANCELLED', 'DONE', 'FATAL', 'IN_PROGRESS', 'IN_QUEUE'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          result_feed_document_id == o.result_feed_document_id
    end
