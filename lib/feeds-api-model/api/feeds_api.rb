...
module AmzSpApi::FeedsApiModel
  class FeedsApi
    ...
    def cancel_feed_with_http_info(feed_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'feed_id' when calling FeedsApi.cancel_feed" if feed_id.nil?
      # resource path
      local_var_path = "/feeds/2021-06-30/feeds/{feedId}".sub('{format}','json').sub('{' + 'feedId' + '}', feed_id.to_s)
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateFeedResponse, Fixnum, Hash)>] CreateFeedResponse data, response status code and response headers
    def create_feed_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FeedsApi.create_feed ..."
      end
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling FeedsApi.create_feed" if body.nil?
      # resource path
      local_var_path = "/feeds/2021-06-30/feeds".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CreateFeedResponse')
      if @api_client.config.debugging
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateFeedDocumentResponse, Fixnum, Hash)>] CreateFeedDocumentResponse data, response status code and response headers
    def create_feed_document_with_http_info(body, opts = {})
      ...
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling FeedsApi.create_feed_document" if body.nil?
      # resource path
      local_var_path = "/feeds/2021-06-30/documents".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CreateFeedDocumentResponse')
      if @api_client.config.debugging
    ...
    # @param feed_id The identifier for the feed. This identifier is unique only in combination with a seller ID.
    # @param [Hash] opts the optional parameters
    # @return [Array<(Feed, Fixnum, Hash)>] Feed data, response status code and response headers
    def get_feed_with_http_info(feed_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FeedsApi.get_feed ..."
      end
      # verify the required parameter 'feed_id' is set
      fail ArgumentError, "Missing the required parameter 'feed_id' when calling FeedsApi.get_feed" if feed_id.nil?
      # resource path
      local_var_path = "/feeds/2021-06-30/feeds/{feedId}".sub('{format}','json').sub('{' + 'feedId' + '}', feed_id.to_s)
    ...
    # @param feed_document_id The identifier of the feed document.
    # @param [Hash] opts the optional parameters
    # @return [Array<(FeedDocument, Fixnum, Hash)>] FeedDocument data, response status code and response headers
    def get_feed_document_with_http_info(feed_document_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'feed_document_id' when calling FeedsApi.get_feed_document" if feed_document_id.nil?
      # resource path
      local_var_path = "/feeds/2021-06-30/documents/{feedDocumentId}".sub('{format}','json').sub('{' + 'feedDocumentId' + '}', feed_document_id.to_s)
    ...
    # @option opts [DateTime] :created_until The latest feed creation date and time for feeds included in the response, in ISO 8601 format. The default is now.
    # @option opts [String] :next_token A string token returned in the response to your previous request. nextToken is returned when the number of results exceeds the specified pageSize value. To get the next page of results, call the getFeeds operation and include this token as the only parameter. Specifying nextToken with any other parameters will cause the request to fail.
    # @return [Array<(GetFeedsResponse, Fixnum, Hash)>] GetFeedsResponse data, response status code and response headers
    def get_feeds_with_http_info(opts = {})
      ...
      if !opts[:'page_size'].nil? && opts[:'page_size'] > 100.0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling FeedsApi.get_feeds, must be smaller than or equal to 100.0.'
      end

      if !opts[:'page_size'].nil? && opts[:'page_size'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling FeedsApi.get_feeds, must be greater than or equal to 1.0.'
      end
