...
module AmzSpApi::FeedsApiModel
  class FeedsApi
    ...
    def get_feeds_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'feed_types'].nil? && opts[:'feed_types'].length > 10
        fail ArgumentError, 'invalid value for "opts[:"feed_types"]" when calling FeedsApi.get_feeds, number of items must be less than or equal to 10.'
      end

      if @api_client.config.client_side_validation && !opts[:'feed_types'].nil? && opts[:'feed_types'].length < 1
        fail ArgumentError, 'invalid value for "opts[:"feed_types"]" when calling FeedsApi.get_feeds, number of items must be greater than or equal to 1.'
      end

      if @api_client.config.client_side_validation && !opts[:'marketplace_ids'].nil? && opts[:'marketplace_ids'].length > 10
        fail ArgumentError, 'invalid value for "opts[:"marketplace_ids"]" when calling FeedsApi.get_feeds, number of items must be less than or equal to 10.'
      end

      if @api_client.config.client_side_validation && !opts[:'marketplace_ids'].nil? && opts[:'marketplace_ids'].length < 1
        fail ArgumentError, 'invalid value for "opts[:"marketplace_ids"]" when calling FeedsApi.get_feeds, number of items must be greater than or equal to 1.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 100
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling FeedsApi.get_feeds, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 1
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling FeedsApi.get_feeds, must be greater than or equal to 1.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'processing_statuses'].nil? && opts[:'processing_statuses'].length < 1
        fail ArgumentError, 'invalid value for "opts[:"processing_statuses"]" when calling FeedsApi.get_feeds, number of items must be greater than or equal to 1.'
      end
