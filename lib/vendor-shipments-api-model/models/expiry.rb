...
module AmzSpApi::VendorShipmentsApiModel
  ...
  class Expiry
    ...
    attr_accessor :expiry_after_duration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'manufacturerDate')
        self.manufacturer_date = attributes[:'manufacturerDate']
      end
      ...
      if attributes.has_key?(:'expiryAfterDuration')
        self.expiry_after_duration = attributes[:'expiryAfterDuration']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          expiry_after_duration == o.expiry_after_duration
    end
    ...
    def hash
      [manufacturer_date, expiry_date, expiry_after_duration].hash
    end
