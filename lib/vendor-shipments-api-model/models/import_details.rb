...
module AmzSpApi::VendorShipmentsApiModel
  ...
  class ImportDetails
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sealNumber')
        self.seal_number = attributes[:'sealNumber']
      end
      ...
      if attributes.has_key?(:'billableWeight')
        self.billable_weight = attributes[:'billableWeight']
      end

      if attributes.has_key?(:'estimatedShipByDate')
        self.estimated_ship_by_date = attributes[:'estimatedShipByDate']
      end
