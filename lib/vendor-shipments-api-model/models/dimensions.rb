...
module AmzSpApi::VendorShipmentsApiModel
  ...
  class Dimensions
    ...
    def valid?
      ...
      unit_of_measure_validator = EnumAttributeValidator.new('String', ['In', 'Ft', 'Meter', 'Yard'])
    ...
    def unit_of_measure=(unit_of_measure)
      validator = EnumAttributeValidator.new('String', ['In', 'Ft', 'Meter', 'Yard'])
    ...
    def hash
      [length, width, height, unit_of_measure].hash
    end
