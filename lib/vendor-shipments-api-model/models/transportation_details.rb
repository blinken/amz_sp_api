...
module AmzSpApi::VendorShipmentsApiModel
  ...
  class TransportationDetails
    ...
    attr_accessor :carrier_shipment_reference_number
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'carrierScac')
        self.carrier_scac = attributes[:'carrierScac']
      end

      if attributes.has_key?(:'carrierShipmentReferenceNumber')
        self.carrier_shipment_reference_number = attributes[:'carrierShipmentReferenceNumber']
      end
      ...
      if attributes.has_key?(:'billOfLadingNumber')
        self.bill_of_lading_number = attributes[:'billOfLadingNumber']
      end
    ...
    def valid?
      transportation_mode_validator = EnumAttributeValidator.new('String', ["Road", "Air", "Ocean"])
    ...
    def transportation_mode=(transportation_mode)
      validator = EnumAttributeValidator.new('String', ["Road", "Air", "Ocean"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          carrier_shipment_reference_number == o.carrier_shipment_reference_number &&
    ...
    def hash
      [carrier_scac, carrier_shipment_reference_number, transportation_mode, bill_of_lading_number].hash
    end
