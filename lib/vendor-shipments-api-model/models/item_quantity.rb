...
module AmzSpApi::VendorShipmentsApiModel
  ...
  class ItemQuantity
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'unitSize')
        self.unit_size = attributes[:'unitSize']
      end
    ...
    def valid?
      ...
      unit_of_measure_validator = EnumAttributeValidator.new('String', ["Cases", "Eaches"])
    ...
    def unit_of_measure=(unit_of_measure)
      validator = EnumAttributeValidator.new('String', ["Cases", "Eaches"])
