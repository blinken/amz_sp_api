...
module AmzSpApi::VendorShipmentsApiModel
  ...
  class Carton
    ...
    def self.swagger_types
      {
        :'carton_identifiers' => :'Array<ContainerIdentification>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cartonIdentifiers')
        if (value = attributes[:'cartonIdentifiers']).is_a?(Array)
          self.carton_identifiers = value
        end
      end

      if attributes.has_key?(:'cartonSequenceNumber')
        self.carton_sequence_number = attributes[:'cartonSequenceNumber']
      end
