...
# Unit tests for AmzSpApi::VendorShipmentsApiModel::TaxRegistrationDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TaxRegistrationDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModel::TaxRegistrationDetails.new
  end
  ...
  describe 'test an instance of TaxRegistrationDetails' do
    it 'should create an instact of TaxRegistrationDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModel::TaxRegistrationDetails)
    end
  end
