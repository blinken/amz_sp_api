...
module AmzSpApi::SalesApiModel
  ...
  class OrderMetricsInterval
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'orderItemCount')
        self.order_item_count = attributes[:'orderItemCount']
      end
      ...
      if attributes.has_key?(:'averageUnitPrice')
        self.average_unit_price = attributes[:'averageUnitPrice']
      end
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        temp_model = AmzSpApi::SalesApiModel.const_get(type).new
