...
describe 'CreateConfirmServiceDetailsResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::MessagingApiModel::CreateConfirmServiceDetailsResponse.new
  end
  ...
  describe 'test an instance of CreateConfirmServiceDetailsResponse' do
    it 'should create an instact of CreateConfirmServiceDetailsResponse' do
