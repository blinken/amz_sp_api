...
module AmzSpApi::MessagingApiModel
  ...
  class CreateConfirmCustomizationDetailsRequest
    ...
    def list_invalid_properties
      ...
      if !@text.nil? && @text.to_s.length > 800
        invalid_properties.push('invalid value for "text", the character length must be smaller than or equal to 800.')
      end
    ...
    def valid?
      return false if !@text.nil? && @text.to_s.length > 800
    ...
    def text=(text)
      if !text.nil? && text.to_s.length > 800
        fail ArgumentError, 'invalid value for "text", the character length must be smaller than or equal to 800.'
      end
