...
module AmzSpApi::MessagingApiModel
  ...
  class CreateDigitalAccessKeyRequest
    ...
    def list_invalid_properties
      ...
      if !@text.nil? && @text.to_s.length > 400
        invalid_properties.push("invalid value for 'text', the character length must be smaller than or equal to 400.")
      end
    ...
    def valid?
      return false if !@text.nil? && @text.to_s.length > 400
    ...
    def text=(text)
      ...
      if !text.nil? && text.to_s.length > 400
        fail ArgumentError, "invalid value for 'text', the character length must be smaller than or equal to 400."
      end
