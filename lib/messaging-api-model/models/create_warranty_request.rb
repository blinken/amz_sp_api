...
module AmzSpApi::MessagingApiModel
  ...
  class CreateWarrantyRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'coverageStartDate')
        self.coverage_start_date = attributes[:'coverageStartDate']
      end

      if attributes.has_key?(:'coverageEndDate')
        self.coverage_end_date = attributes[:'coverageEndDate']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          coverage_start_date == o.coverage_start_date &&
          coverage_end_date == o.coverage_end_date
    end
    ...
    def hash
      [attachments, coverage_start_date, coverage_end_date].hash
    end
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        temp_model = AmzSpApi::MessagingApiModel.const_get(type).new
