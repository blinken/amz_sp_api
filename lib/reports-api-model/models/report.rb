...
module AmzSpApi::ReportsApiModel
  ...
  class Report
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dataStartTime')
        self.data_start_time = attributes[:'dataStartTime']
      end

      if attributes.has_key?(:'dataEndTime')
        self.data_end_time = attributes[:'dataEndTime']
      end

      if attributes.has_key?(:'reportScheduleId')
        self.report_schedule_id = attributes[:'reportScheduleId']
      end
