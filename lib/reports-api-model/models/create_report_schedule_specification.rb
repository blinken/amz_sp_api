...
module AmzSpApi::ReportsApiModel
  class CreateReportScheduleSpecification
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reportOptions')
        self.report_options = attributes[:'reportOptions']
      end
      ...
      if attributes.has_key?(:'nextReportCreationTime')
        self.next_report_creation_time = attributes[:'nextReportCreationTime']
      end
    end
    ...
    def valid?
      ...
      period_validator = EnumAttributeValidator.new('String', ['PT5M', 'PT15M', 'PT30M', 'PT1H', 'PT2H', 'PT4H', 'PT8H', 'PT12H', 'P1D', 'P2D', 'P3D', 'PT84H', 'P7D', 'P14D', 'P15D', 'P18D', 'P30D', 'P1M'])
    ...
    def period=(period)
      validator = EnumAttributeValidator.new('String', ['PT5M', 'PT15M', 'PT30M', 'PT1H', 'PT2H', 'PT4H', 'PT8H', 'PT12H', 'P1D', 'P2D', 'P3D', 'PT84H', 'P7D', 'P14D', 'P15D', 'P18D', 'P30D', 'P1M'])
