...
module AmzSpApi::ReportsApiModel
  class ReportsApi
    ...
    # @param report_id The identifier for the report. This identifier is unique only in combination with a seller ID.
    # @param [Hash] opts the optional parameters
    # @return [Array<(CancelReportResponse, Fixnum, Hash)>] CancelReportResponse data, response status code and response headers
    def cancel_report_with_http_info(report_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'report_id' when calling ReportsApi.cancel_report" if report_id.nil?
      # resource path
      local_var_path = "/reports/2020-09-04/reports/{reportId}".sub('{format}','json').sub('{' + 'reportId' + '}', report_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'CancelReportResponse')
      if @api_client.config.debugging
    ...
    # @param report_schedule_id The identifier for the report schedule. This identifier is unique only in combination with a seller ID.
    # @param [Hash] opts the optional parameters
    # @return [Array<(CancelReportScheduleResponse, Fixnum, Hash)>] CancelReportScheduleResponse data, response status code and response headers
    def cancel_report_schedule_with_http_info(report_schedule_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'report_schedule_id' when calling ReportsApi.cancel_report_schedule" if report_schedule_id.nil?
      # resource path
      local_var_path = "/reports/2020-09-04/schedules/{reportScheduleId}".sub('{format}','json').sub('{' + 'reportScheduleId' + '}', report_schedule_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CancelReportScheduleResponse')
      if @api_client.config.debugging
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateReportResponse, Fixnum, Hash)>] CreateReportResponse data, response status code and response headers
    def create_report_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ReportsApi.create_report ..."
      end
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling ReportsApi.create_report" if body.nil?
      # resource path
      local_var_path = "/reports/2020-09-04/reports".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CreateReportResponse')
      if @api_client.config.debugging
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateReportScheduleResponse, Fixnum, Hash)>] CreateReportScheduleResponse data, response status code and response headers
    def create_report_schedule_with_http_info(body, opts = {})
      ...
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling ReportsApi.create_report_schedule" if body.nil?
      # resource path
      local_var_path = "/reports/2020-09-04/schedules".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CreateReportScheduleResponse')
      if @api_client.config.debugging
    ...
    # @param report_id The identifier for the report. This identifier is unique only in combination with a seller ID.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetReportResponse, Fixnum, Hash)>] GetReportResponse data, response status code and response headers
    def get_report_with_http_info(report_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ReportsApi.get_report ..."
      end
      # verify the required parameter 'report_id' is set
      fail ArgumentError, "Missing the required parameter 'report_id' when calling ReportsApi.get_report" if report_id.nil?
      # resource path
      local_var_path = "/reports/2020-09-04/reports/{reportId}".sub('{format}','json').sub('{' + 'reportId' + '}', report_id.to_s)
    ...
    # @param report_document_id The identifier for the report document.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetReportDocumentResponse, Fixnum, Hash)>] GetReportDocumentResponse data, response status code and response headers
    def get_report_document_with_http_info(report_document_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'report_document_id' when calling ReportsApi.get_report_document" if report_document_id.nil?
      # resource path
      local_var_path = "/reports/2020-09-04/documents/{reportDocumentId}".sub('{format}','json').sub('{' + 'reportDocumentId' + '}', report_document_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetReportDocumentResponse')
      if @api_client.config.debugging
    ...
    # @param report_schedule_id The identifier for the report schedule. This identifier is unique only in combination with a seller ID.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetReportScheduleResponse, Fixnum, Hash)>] GetReportScheduleResponse data, response status code and response headers
    def get_report_schedule_with_http_info(report_schedule_id, opts = {})
      ...
      # verify the required parameter 'report_schedule_id' is set
      fail ArgumentError, "Missing the required parameter 'report_schedule_id' when calling ReportsApi.get_report_schedule" if report_schedule_id.nil?
      # resource path
      local_var_path = "/reports/2020-09-04/schedules/{reportScheduleId}".sub('{format}','json').sub('{' + 'reportScheduleId' + '}', report_schedule_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetReportScheduleResponse')
      if @api_client.config.debugging
    ...
    # @param report_types A list of report types used to filter report schedules.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetReportSchedulesResponse, Fixnum, Hash)>] GetReportSchedulesResponse data, response status code and response headers
    def get_report_schedules_with_http_info(report_types, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'report_types' when calling ReportsApi.get_report_schedules" if report_types.nil?
      # resource path
      local_var_path = "/reports/2020-09-04/schedules".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetReportSchedulesResponse')
      if @api_client.config.debugging
    ...
    # @option opts [DateTime] :created_until The latest report creation date and time for reports to include in the response, in ISO 8601 date time format. The default is now.
    # @option opts [String] :next_token A string token returned in the response to your previous request. nextToken is returned when the number of results exceeds the specified pageSize value. To get the next page of results, call the getReports operation and include this token as the only parameter. Specifying nextToken with any other parameters will cause the request to fail.
    # @return [Array<(GetReportsResponse, Fixnum, Hash)>] GetReportsResponse data, response status code and response headers
    def get_reports_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ReportsApi.get_reports ..."
      end
      if opts[:'processing_statuses'] && !['CANCELLED', 'DONE', 'FATAL', 'IN_PROGRESS', 'IN_QUEUE'].include?(opts[:'processing_statuses'])
        fail ArgumentError, 'invalid value for "processing_statuses", must be one of CANCELLED, DONE, FATAL, IN_PROGRESS, IN_QUEUE'
      end
      if !opts[:'page_size'].nil? && opts[:'page_size'] > 100.0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ReportsApi.get_reports, must be smaller than or equal to 100.0.'
      end

      if !opts[:'page_size'].nil? && opts[:'page_size'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ReportsApi.get_reports, must be greater than or equal to 1.0.'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetReportsResponse')
      if @api_client.config.debugging
