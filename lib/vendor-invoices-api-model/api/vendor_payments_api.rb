...
module AmzSpApi::VendorInvoicesApiModel
  class VendorPaymentsApi
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(SubmitInvoicesResponse, Fixnum, Hash)>] SubmitInvoicesResponse data, response status code and response headers
    def submit_invoices_with_http_info(body, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'body' when calling VendorPaymentsApi.submit_invoices" if body.nil?
      # resource path
      local_var_path = "/vendor/payments/v1/invoices".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'SubmitInvoicesResponse')
      if @api_client.config.debugging
