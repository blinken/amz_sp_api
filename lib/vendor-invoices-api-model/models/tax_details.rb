...
module AmzSpApi::VendorInvoicesApiModel
  ...
  class TaxDetails
    ...
    def valid?
      ...
      tax_type_validator = EnumAttributeValidator.new('String', ["CGST", "SGST", "CESS", "UTGST", "IGST", "MwSt.", "PST", "TVA", "VAT", "GST", "ST", "Consumption", "MutuallyDefined", "DomesticVAT"])
    ...
    def tax_type=(tax_type)
      validator = EnumAttributeValidator.new('String', ["CGST", "SGST", "CESS", "UTGST", "IGST", "MwSt.", "PST", "TVA", "VAT", "GST", "ST", "Consumption", "MutuallyDefined", "DomesticVAT"])
    ...
    def hash
      [tax_type, tax_rate, tax_amount, taxable_amount].hash
    end
