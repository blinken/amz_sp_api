...
module AmzSpApi::VendorInvoicesApiModel
  ...
  class AdditionalDetails
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['SUR', 'OCR', 'CartonCount'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['SUR', 'OCR', 'CartonCount'])
    ...
    def hash
      [type, detail, language_code].hash
    end
