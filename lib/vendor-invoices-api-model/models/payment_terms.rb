...
module AmzSpApi::VendorInvoicesApiModel
  ...
  class PaymentTerms
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'discountDueDays')
        self.discount_due_days = attributes[:'discountDueDays']
      end

      if attributes.has_key?(:'netDueDays')
        self.net_due_days = attributes[:'netDueDays']
      end
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ["Basic", "EndOfMonth", "FixedDate", "Proximo", "PaymentDueUponReceiptOfInvoice", "LetterofCredit"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["Basic", "EndOfMonth", "FixedDate", "Proximo", "PaymentDueUponReceiptOfInvoice", "LetterofCredit"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          discount_due_days == o.discount_due_days &&
          net_due_days == o.net_due_days
    end
    ...
    def hash
      [type, discount_percent, discount_due_days, net_due_days].hash
    end
