...
module AmzSpApi::ShippingApiModel
  ...
  class ServiceRate
    ...
    def list_invalid_properties
      ...
      if @billable_weight.nil?
        invalid_properties.push('invalid value for "billable_weight", billable_weight cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @billable_weight.nil?
    ...
    def hash
      [total_charge, billable_weight, service_type, promise].hash
    end
