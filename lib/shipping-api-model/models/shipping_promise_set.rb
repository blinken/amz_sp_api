...
module AmzSpApi::ShippingApiModel
  ...
  class ShippingPromiseSet
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'receiveWindow')
        self.receive_window = attributes[:'receiveWindow']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          receive_window == o.receive_window
    end
    ...
    def hash
      [delivery_window, receive_window].hash
    end
