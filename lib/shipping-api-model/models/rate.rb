...
module AmzSpApi::ShippingApiModel
  ...
  class Rate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'billedWeight')
        self.billed_weight = attributes[:'billedWeight']
      end
    ...
    def hash
      [rate_id, total_charge, billed_weight, expiration_time, service_type, promise].hash
    end
