...
module AmzSpApi::ShippingApiModel
  ...
  class ContainerItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'unitWeight')
        self.unit_weight = attributes[:'unitWeight']
      end
    ...
    def list_invalid_properties
      ...
      if @unit_weight.nil?
        invalid_properties.push('invalid value for "unit_weight", unit_weight cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @unit_weight.nil?
      return false if @title.nil?
      return false if @title.to_s.length > 30
      true
    end
    ...
    def hash
      [quantity, unit_price, unit_weight, title].hash
    end
