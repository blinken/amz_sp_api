...
# Unit tests for AmzSpApi::ShippingApiModel::ServiceRate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceRate' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModel::ServiceRate.new
  end
  ...
  describe 'test an instance of ServiceRate' do
    it 'should create an instact of ServiceRate' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModel::ServiceRate)
    end
  end
