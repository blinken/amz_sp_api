...
module AmzSpApi::ProductPricingApiModel
  ...
  class SellerFeedbackType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SellerPositiveFeedbackRating')
        self.seller_positive_feedback_rating = attributes[:'SellerPositiveFeedbackRating']
      end

      if attributes.has_key?(:'FeedbackCount')
        self.feedback_count = attributes[:'FeedbackCount']
      end
    end
