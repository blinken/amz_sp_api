...
module AmzSpApi::ProductPricingApiModel
  ...
  class DetailedShippingTimeType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'maximumHours')
        self.maximum_hours = attributes[:'maximumHours']
      end

      if attributes.has_key?(:'availableDate')
        self.available_date = attributes[:'availableDate']
      end

      if attributes.has_key?(:'availabilityType')
        self.availability_type = attributes[:'availabilityType']
      end
    ...
    def valid?
      availability_type_validator = EnumAttributeValidator.new('String', ["NOW", "FUTURE_WITHOUT_DATE", "FUTURE_WITH_DATE"])
      return false unless availability_type_validator.valid?(@availability_type)
      return true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] availability_type Object to be assigned
    def availability_type=(availability_type)
      validator = EnumAttributeValidator.new('String', ["NOW", "FUTURE_WITHOUT_DATE", "FUTURE_WITH_DATE"])
