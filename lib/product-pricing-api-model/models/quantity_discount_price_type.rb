...
module AmzSpApi::ProductPricingApiModel
  ...
  class QuantityDiscountPriceType
    ...
    def list_invalid_properties
      ...
      if @quantity_tier.nil?
        invalid_properties.push('invalid value for "quantity_tier", quantity_tier cannot be nil.')
      end

      if @quantity_discount_type.nil?
        invalid_properties.push('invalid value for "quantity_discount_type", quantity_discount_type cannot be nil.')
      end
    ...
    def valid?
      return false if @quantity_tier.nil?
      return false if @quantity_discount_type.nil?
    ...
    def hash
      [quantity_tier, quantity_discount_type, listing_price].hash
    end
