...
module AmzSpApi::ProductPricingApiModel
  ...
  class OfferDetail
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ConditionNotes')
        self.condition_notes = attributes[:'ConditionNotes']
      end
      ...
      if attributes.has_key?(:'PrimeInformation')
        self.prime_information = attributes[:'PrimeInformation']
      end
