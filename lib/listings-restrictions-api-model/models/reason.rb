...
module AmzSpApi::ListingsRestrictionsApiModel
  ...
  class Reason
    ...
    def valid?
      ...
      reason_code_validator = EnumAttributeValidator.new('String', ["APPROVAL_REQUIRED", "ASIN_NOT_FOUND", "NOT_ELIGIBLE"])
    ...
    def reason_code=(reason_code)
      validator = EnumAttributeValidator.new('String', ["APPROVAL_REQUIRED", "ASIN_NOT_FOUND", "NOT_ELIGIBLE"])
    ...
    def hash
      [message, reason_code, links].hash
    end
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+), (?<v_type>.+)>\z/
        ...
        temp_model = AmzSpApi::ListingsRestrictionsApiModel.const_get(type).new
