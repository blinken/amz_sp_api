...
module AmzSpApi::ListingsRestrictionsApiModel
  class ListingsApi
    ...
    # @option opts [String] :condition_type The condition used to filter restrictions.
    # @option opts [String] :reason_locale A locale for reason text localization. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale.
    # @return [Array<(RestrictionList, Fixnum, Hash)>] RestrictionList data, response status code and response headers
    def get_listings_restrictions_with_http_info(asin, seller_id, marketplace_ids, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'asin' when calling ListingsApi.get_listings_restrictions" if asin.nil?
      # verify the required parameter 'seller_id' is set
      fail ArgumentError, "Missing the required parameter 'seller_id' when calling ListingsApi.get_listings_restrictions" if seller_id.nil?
      # verify the required parameter 'marketplace_ids' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_ids' when calling ListingsApi.get_listings_restrictions" if marketplace_ids.nil?
      if opts[:'condition_type'] && !['new_new', 'new_open_box', 'new_oem', 'refurbished_refurbished', 'used_like_new', 'used_very_good', 'used_good', 'used_acceptable', 'collectible_like_new', 'collectible_very_good', 'collectible_good', 'collectible_acceptable', 'club_club'].include?(opts[:'condition_type'])
      ...
      # resource path
      local_var_path = "/listings/2021-08-01/restrictions".sub('{format}','json')
