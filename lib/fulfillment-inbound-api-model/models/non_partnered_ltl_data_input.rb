...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class NonPartneredLtlDataInput
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ProNumber')
        self.pro_number = attributes[:'ProNumber']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @pro_number.nil?
        invalid_properties.push('invalid value for "pro_number", pro_number cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @pro_number.nil?
      true
    end
