...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class SKUInboundGuidance
    ...
    attr_accessor :inbound_guidance

    # A list of reasons for the current inbound guidance for this item.
    attr_accessor :guidance_reason_list
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'InboundGuidance')
        self.inbound_guidance = attributes[:'InboundGuidance']
      end

      if attributes.has_key?(:'GuidanceReasonList')
        self.guidance_reason_list = attributes[:'GuidanceReasonList']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @inbound_guidance.nil?
        invalid_properties.push('invalid value for "inbound_guidance", inbound_guidance cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @inbound_guidance.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          asin == o.asin &&
          inbound_guidance == o.inbound_guidance &&
          guidance_reason_list == o.guidance_reason_list
    end
    ...
    def hash
      [seller_sku, asin, inbound_guidance, guidance_reason_list].hash
    end
