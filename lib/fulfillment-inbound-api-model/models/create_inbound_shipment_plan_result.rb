...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class CreateInboundShipmentPlanResult
    attr_accessor :inbound_shipment_plans
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'InboundShipmentPlans')
        self.inbound_shipment_plans = attributes[:'InboundShipmentPlans']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          inbound_shipment_plans == o.inbound_shipment_plans
    end
