...
module AmzSpApi::FulfillmentInboundApiModel
  class GetPreorderInfoResult
    ...
    attr_accessor :shipment_confirmed_for_preorder
    ...
    attr_accessor :confirmed_fulfillable_date
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ShipmentContainsPreorderableItems')
        self.shipment_contains_preorderable_items = attributes[:'ShipmentContainsPreorderableItems']
      end

      if attributes.has_key?(:'ShipmentConfirmedForPreorder')
        self.shipment_confirmed_for_preorder = attributes[:'ShipmentConfirmedForPreorder']
      end

      if attributes.has_key?(:'NeedByDate')
        self.need_by_date = attributes[:'NeedByDate']
      end

      if attributes.has_key?(:'ConfirmedFulfillableDate')
        self.confirmed_fulfillable_date = attributes[:'ConfirmedFulfillableDate']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          shipment_contains_preorderable_items == o.shipment_contains_preorderable_items &&
          shipment_confirmed_for_preorder == o.shipment_confirmed_for_preorder &&
          need_by_date == o.need_by_date &&
          confirmed_fulfillable_date == o.confirmed_fulfillable_date
    end
    ...
    def hash
      [shipment_contains_preorderable_items, shipment_confirmed_for_preorder, need_by_date, confirmed_fulfillable_date].hash
    end
