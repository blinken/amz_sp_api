...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class InboundShipmentPlanItem
    ...
    def list_invalid_properties
      ...
      if @fulfillment_network_sku.nil?
        invalid_properties.push('invalid value for "fulfillment_network_sku", fulfillment_network_sku cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @fulfillment_network_sku.nil?
    ...
    def hash
      [seller_sku, fulfillment_network_sku, quantity, prep_details_list].hash
    end
