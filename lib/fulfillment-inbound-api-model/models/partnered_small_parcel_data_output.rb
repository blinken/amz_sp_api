...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class PartneredSmallParcelDataOutput
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PackageList')
        self.package_list = attributes[:'PackageList']
      end
    ...
    def list_invalid_properties
      ...
      if @package_list.nil?
        invalid_properties.push('invalid value for "package_list", package_list cannot be nil.')
      end
    ...
    def valid?
      return false if @package_list.nil?
      true
    end
    ...
    def hash
      [package_list, partnered_estimate].hash
    end
