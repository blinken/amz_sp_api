...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class TransportResult
    attr_accessor :transport_status
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TransportStatus')
        self.transport_status = attributes[:'TransportStatus']
      end
    ...
    def list_invalid_properties
      ...
      if @transport_status.nil?
        invalid_properties.push('invalid value for "transport_status", transport_status cannot be nil.')
      end
    ...
    def valid?
      return false if @transport_status.nil?
      true
    end
    ...
    def hash
      [transport_status, error_code, error_description].hash
    end
