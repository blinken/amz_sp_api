...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class PartneredEstimate
    ...
    attr_accessor :confirm_deadline
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ConfirmDeadline')
        self.confirm_deadline = attributes[:'ConfirmDeadline']
      end

      if attributes.has_key?(:'VoidDeadline')
        self.void_deadline = attributes[:'VoidDeadline']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          amount == o.amount &&
          confirm_deadline == o.confirm_deadline &&
          void_deadline == o.void_deadline
    end
    ...
    def hash
      [amount, confirm_deadline, void_deadline].hash
    end
