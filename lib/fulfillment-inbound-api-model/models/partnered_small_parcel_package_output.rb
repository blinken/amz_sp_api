...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class PartneredSmallParcelPackageOutput
    ...
    def list_invalid_properties
      ...
      if @package_status.nil?
        invalid_properties.push('invalid value for "package_status", package_status cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @package_status.nil?
      true
    end
    ...
    def hash
      [dimensions, weight, carrier_name, tracking_id, package_status].hash
    end
