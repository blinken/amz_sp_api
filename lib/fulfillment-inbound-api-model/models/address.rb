...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class Address
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'StateOrProvinceCode')
        self.state_or_province_code = attributes[:'StateOrProvinceCode']
      end
    ...
    def list_invalid_properties
      ...
      if !@district_or_county.nil? && @district_or_county.to_s.length > 25
        invalid_properties.push("invalid value for 'district_or_county', the character length must be smaller than or equal to 25.")
      end
    ...
    def valid?
      ...
      return false if !@district_or_county.nil? && @district_or_county.to_s.length > 25
    ...
    # Custom attribute writer method with validation
    # @param [Object] district_or_county Value to be assigned
    def district_or_county=(district_or_county)

      if !district_or_county.nil? && district_or_county.to_s.length > 25
        fail ArgumentError, "invalid value for 'district_or_county', the character length must be smaller than or equal to 25."
      end
