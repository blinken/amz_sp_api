...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class Pallet
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IsStacked')
        self.is_stacked = attributes[:'IsStacked']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @is_stacked.nil?
        invalid_properties.push('invalid value for "is_stacked", is_stacked cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_stacked.nil?
      true
    end
