...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class CreateInboundShipmentPlanRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ShipToCountrySubdivisionCode')
        self.ship_to_country_subdivision_code = attributes[:'ShipToCountrySubdivisionCode']
      end

      if attributes.has_key?(:'InboundShipmentPlanRequestItems')
        self.inbound_shipment_plan_request_items = attributes[:'InboundShipmentPlanRequestItems']
      end
    end
