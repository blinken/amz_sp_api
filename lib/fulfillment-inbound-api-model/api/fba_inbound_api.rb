...
module AmzSpApi::FulfillmentInboundApiModel
  class FbaInboundApi
    ...
    def get_inbound_guidance_with_http_info(marketplace_id, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'seller_sku_list'].nil? && opts[:'seller_sku_list'].length > 50
        fail ArgumentError, 'invalid value for "opts[:"seller_sku_list"]" when calling FbaInboundApi.get_inbound_guidance, number of items must be less than or equal to 50.'
      end

      if @api_client.config.client_side_validation && !opts[:'asin_list'].nil? && opts[:'asin_list'].length > 50
        fail ArgumentError, 'invalid value for "opts[:"asin_list"]" when calling FbaInboundApi.get_inbound_guidance, number of items must be less than or equal to 50.'
      end
    ...
    def get_labels_with_http_info(shipment_id, page_type, label_type, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'package_labels_to_print'].nil? && opts[:'package_labels_to_print'].length > 999
        fail ArgumentError, 'invalid value for "opts[:"package_labels_to_print"]" when calling FbaInboundApi.get_labels, number of items must be less than or equal to 999.'
      end
    ...
    def get_prep_instructions_with_http_info(ship_to_country_code, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'seller_sku_list'].nil? && opts[:'seller_sku_list'].length > 50
        fail ArgumentError, 'invalid value for "opts[:"seller_sku_list"]" when calling FbaInboundApi.get_prep_instructions, number of items must be less than or equal to 50.'
      end

      if @api_client.config.client_side_validation && !opts[:'asin_list'].nil? && opts[:'asin_list'].length > 50
        fail ArgumentError, 'invalid value for "opts[:"asin_list"]" when calling FbaInboundApi.get_prep_instructions, number of items must be less than or equal to 50.'
      end
