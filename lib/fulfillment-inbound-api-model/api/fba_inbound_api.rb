...
module AmzSpApi::FulfillmentInboundApiModel
  class FbaInboundApi
    ...
    # @param marketplace_id A marketplace identifier. Specifies the marketplace the shipment is tied to.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ConfirmPreorderResponse, Fixnum, Hash)>] ConfirmPreorderResponse data, response status code and response headers
    def confirm_preorder_with_http_info(shipment_id, need_by_date, marketplace_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FbaInboundApi.confirm_preorder" if shipment_id.nil?
      # verify the required parameter 'need_by_date' is set
      fail ArgumentError, "Missing the required parameter 'need_by_date' when calling FbaInboundApi.confirm_preorder" if need_by_date.nil?
      # verify the required parameter 'marketplace_id' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_id' when calling FbaInboundApi.confirm_preorder" if marketplace_id.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/shipments/{shipmentId}/preorder/confirm".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ConfirmPreorderResponse')
      if @api_client.config.debugging
    ...
    # @param shipment_id A shipment identifier originally returned by the createInboundShipmentPlan operation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ConfirmTransportResponse, Fixnum, Hash)>] ConfirmTransportResponse data, response status code and response headers
    def confirm_transport_with_http_info(shipment_id, opts = {})
      ...
      # verify the required parameter 'shipment_id' is set
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FbaInboundApi.confirm_transport" if shipment_id.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/shipments/{shipmentId}/transport/confirm".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ConfirmTransportResponse')
      if @api_client.config.debugging
    ...
    # @param shipment_id A shipment identifier originally returned by the createInboundShipmentPlan operation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(InboundShipmentResponse, Fixnum, Hash)>] InboundShipmentResponse data, response status code and response headers
    def create_inbound_shipment_with_http_info(body, shipment_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'body' when calling FbaInboundApi.create_inbound_shipment" if body.nil?
      # verify the required parameter 'shipment_id' is set
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FbaInboundApi.create_inbound_shipment" if shipment_id.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/shipments/{shipmentId}".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'InboundShipmentResponse')
      if @api_client.config.debugging
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateInboundShipmentPlanResponse, Fixnum, Hash)>] CreateInboundShipmentPlanResponse data, response status code and response headers
    def create_inbound_shipment_plan_with_http_info(body, opts = {})
      ...
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling FbaInboundApi.create_inbound_shipment_plan" if body.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/plans".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CreateInboundShipmentPlanResponse')
      if @api_client.config.debugging
    ...
    # @param shipment_id A shipment identifier originally returned by the createInboundShipmentPlan operation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(EstimateTransportResponse, Fixnum, Hash)>] EstimateTransportResponse data, response status code and response headers
    def estimate_transport_with_http_info(shipment_id, opts = {})
      ...
      # verify the required parameter 'shipment_id' is set
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FbaInboundApi.estimate_transport" if shipment_id.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/shipments/{shipmentId}/transport/estimate".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'EstimateTransportResponse')
      if @api_client.config.debugging
    ...
    # @param shipment_id A shipment identifier originally returned by the createInboundShipmentPlan operation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetBillOfLadingResponse, Fixnum, Hash)>] GetBillOfLadingResponse data, response status code and response headers
    def get_bill_of_lading_with_http_info(shipment_id, opts = {})
      ...
      # verify the required parameter 'shipment_id' is set
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FbaInboundApi.get_bill_of_lading" if shipment_id.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/shipments/{shipmentId}/billOfLading".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetBillOfLadingResponse')
      if @api_client.config.debugging
    ...
    # @option opts [Array<String>] :seller_sku_list A list of SellerSKU values. Used to identify items for which you want inbound guidance for shipment to Amazon&#39;s fulfillment network. Note: SellerSKU is qualified by the SellerId, which is included with every Selling Partner API operation that you submit. If you specify a SellerSKU that identifies a variation parent ASIN, this operation returns an error. A variation parent ASIN represents a generic product that cannot be sold. Variation child ASINs represent products that have specific characteristics (such as size and color) and can be sold. 
    # @option opts [Array<String>] :asin_list A list of ASIN values. Used to identify items for which you want inbound guidance for shipment to Amazon&#39;s fulfillment network. Note: If you specify a ASIN that identifies a variation parent ASIN, this operation returns an error. A variation parent ASIN represents a generic product that cannot be sold. Variation child ASINs represent products that have specific characteristics (such as size and color) and can be sold.
    # @return [Array<(GetInboundGuidanceResponse, Fixnum, Hash)>] GetInboundGuidanceResponse data, response status code and response headers
    def get_inbound_guidance_with_http_info(marketplace_id, opts = {})
      ...
      # verify the required parameter 'marketplace_id' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_id' when calling FbaInboundApi.get_inbound_guidance" if marketplace_id.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/itemsGuidance".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetInboundGuidanceResponse')
      if @api_client.config.debugging
    ...
    # @option opts [Integer] :page_size The page size for paginating through the total packages&#39; labels. This is a required parameter for Non-Partnered LTL Shipments. Max value:1000.
    # @option opts [Integer] :page_start_index The page start index for paginating through the total packages&#39; labels. This is a required parameter for Non-Partnered LTL Shipments.
    # @return [Array<(GetLabelsResponse, Fixnum, Hash)>] GetLabelsResponse data, response status code and response headers
    def get_labels_with_http_info(shipment_id, page_type, label_type, opts = {})
      ...
      # verify the required parameter 'shipment_id' is set
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FbaInboundApi.get_labels" if shipment_id.nil?
      # verify the required parameter 'page_type' is set
      fail ArgumentError, "Missing the required parameter 'page_type' when calling FbaInboundApi.get_labels" if page_type.nil?
      # verify enum value
      unless ['PackageLabel_Letter_2', 'PackageLabel_Letter_4', 'PackageLabel_Letter_6', 'PackageLabel_Letter_6_CarrierLeft', 'PackageLabel_A4_2', 'PackageLabel_A4_4', 'PackageLabel_Plain_Paper', 'PackageLabel_Plain_Paper_CarrierBottom', 'PackageLabel_Thermal', 'PackageLabel_Thermal_Unified', 'PackageLabel_Thermal_NonPCP', 'PackageLabel_Thermal_No_Carrier_Rotation'].include?(page_type)
      ...
      fail ArgumentError, "Missing the required parameter 'label_type' when calling FbaInboundApi.get_labels" if label_type.nil?
      # verify enum value
      unless ['BARCODE_2D', 'UNIQUE', 'PALLET'].include?(label_type)
        fail ArgumentError, "invalid value for 'label_type', must be one of BARCODE_2D, UNIQUE, PALLET"
      end
      # resource path
      local_var_path = "/fba/inbound/v0/shipments/{shipmentId}/labels".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
    ...
    # @param marketplace_id A marketplace identifier. Specifies the marketplace the shipment is tied to.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetPreorderInfoResponse, Fixnum, Hash)>] GetPreorderInfoResponse data, response status code and response headers
    def get_preorder_info_with_http_info(shipment_id, marketplace_id, opts = {})
      ...
      # verify the required parameter 'shipment_id' is set
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FbaInboundApi.get_preorder_info" if shipment_id.nil?
      # verify the required parameter 'marketplace_id' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_id' when calling FbaInboundApi.get_preorder_info" if marketplace_id.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/shipments/{shipmentId}/preorder".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetPreorderInfoResponse')
      if @api_client.config.debugging
    ...
    # @option opts [Array<String>] :seller_sku_list A list of SellerSKU values. Used to identify items for which you want labeling requirements and item preparation instructions for shipment to Amazon&#39;s fulfillment network. The SellerSKU is qualified by the Seller ID, which is included with every call to the Seller Partner API.  Note: Include seller SKUs that you have used to list items on Amazon&#39;s retail website. If you include a seller SKU that you have never used to list an item on Amazon&#39;s retail website, the seller SKU is returned in the InvalidSKUList property in the response.
    # @option opts [Array<String>] :asin_list A list of ASIN values. Used to identify items for which you want item preparation instructions to help with item sourcing decisions.  Note: ASINs must be included in the product catalog for at least one of the marketplaces that the seller  participates in. Any ASIN that is not included in the product catalog for at least one of the marketplaces that the seller participates in is returned in the InvalidASINList property in the response. You can find out which marketplaces a seller participates in by calling the getMarketplaceParticipations operation in the Selling Partner API for Sellers.
    # @return [Array<(GetPrepInstructionsResponse, Fixnum, Hash)>] GetPrepInstructionsResponse data, response status code and response headers
    def get_prep_instructions_with_http_info(ship_to_country_code, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'ship_to_country_code' when calling FbaInboundApi.get_prep_instructions" if ship_to_country_code.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/prepInstructions".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetPrepInstructionsResponse')
      if @api_client.config.debugging
    ...
    # @option opts [DateTime] :last_updated_before A date used for selecting inbound shipment items that were last updated before (or at) a specified time. The selection includes updates made by Amazon and by the seller.
    # @option opts [String] :next_token A string token returned in the response to your previous request.
    # @return [Array<(GetShipmentItemsResponse, Fixnum, Hash)>] GetShipmentItemsResponse data, response status code and response headers
    def get_shipment_items_with_http_info(query_type, marketplace_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'query_type' when calling FbaInboundApi.get_shipment_items" if query_type.nil?
      # verify enum value
      unless ['DATE_RANGE', 'NEXT_TOKEN'].include?(query_type)
        fail ArgumentError, "invalid value for 'query_type', must be one of DATE_RANGE, NEXT_TOKEN"
      end
      # verify the required parameter 'marketplace_id' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_id' when calling FbaInboundApi.get_shipment_items" if marketplace_id.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/shipmentItems".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetShipmentItemsResponse')
      if @api_client.config.debugging
    ...
    def get_shipment_items_by_shipment_id_with_http_info(shipment_id, marketplace_id, opts = {})
      ...
      # verify the required parameter 'shipment_id' is set
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FbaInboundApi.get_shipment_items_by_shipment_id" if shipment_id.nil?
      # verify the required parameter 'marketplace_id' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_id' when calling FbaInboundApi.get_shipment_items_by_shipment_id" if marketplace_id.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/shipments/{shipmentId}/items".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
    ...
    # @option opts [DateTime] :last_updated_before A date used for selecting inbound shipments that were last updated before (or at) a specified time. The selection includes updates made by Amazon and by the seller.
    # @option opts [String] :next_token A string token returned in the response to your previous request.
    # @return [Array<(GetShipmentsResponse, Fixnum, Hash)>] GetShipmentsResponse data, response status code and response headers
    def get_shipments_with_http_info(query_type, marketplace_id, opts = {})
      ...
      # verify the required parameter 'query_type' is set
      fail ArgumentError, "Missing the required parameter 'query_type' when calling FbaInboundApi.get_shipments" if query_type.nil?
      # verify enum value
      unless ['SHIPMENT', 'DATE_RANGE', 'NEXT_TOKEN'].include?(query_type)
        fail ArgumentError, "invalid value for 'query_type', must be one of SHIPMENT, DATE_RANGE, NEXT_TOKEN"
      end
      # verify the required parameter 'marketplace_id' is set
      fail ArgumentError, "Missing the required parameter 'marketplace_id' when calling FbaInboundApi.get_shipments" if marketplace_id.nil?
      if opts[:'shipment_status_list'] && !['WORKING', 'SHIPPED', 'RECEIVING', 'CANCELLED', 'DELETED', 'CLOSED', 'ERROR', 'IN_TRANSIT', 'DELIVERED', 'CHECKED_IN'].include?(opts[:'shipment_status_list'])
        fail ArgumentError, 'invalid value for "shipment_status_list", must be one of WORKING, SHIPPED, RECEIVING, CANCELLED, DELETED, CLOSED, ERROR, IN_TRANSIT, DELIVERED, CHECKED_IN'
      end
      # resource path
      local_var_path = "/fba/inbound/v0/shipments".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetShipmentsResponse')
      if @api_client.config.debugging
    ...
    # @param shipment_id A shipment identifier originally returned by the createInboundShipmentPlan operation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetTransportDetailsResponse, Fixnum, Hash)>] GetTransportDetailsResponse data, response status code and response headers
    def get_transport_details_with_http_info(shipment_id, opts = {})
      ...
      # verify the required parameter 'shipment_id' is set
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FbaInboundApi.get_transport_details" if shipment_id.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/shipments/{shipmentId}/transport".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetTransportDetailsResponse')
      if @api_client.config.debugging
    ...
    def put_transport_details(shipment_id, body, opts = {})
      data, _status_code, _headers = put_transport_details_with_http_info(shipment_id, body, opts)
      return data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PutTransportDetailsResponse, Fixnum, Hash)>] PutTransportDetailsResponse data, response status code and response headers
    def put_transport_details_with_http_info(shipment_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FbaInboundApi.put_transport_details ..."
      end
      # verify the required parameter 'shipment_id' is set
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FbaInboundApi.put_transport_details" if shipment_id.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling FbaInboundApi.put_transport_details" if body.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/shipments/{shipmentId}/transport".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PutTransportDetailsResponse')
      if @api_client.config.debugging
    ...
    def update_inbound_shipment_with_http_info(body, shipment_id, opts = {})
      ...
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling FbaInboundApi.update_inbound_shipment" if body.nil?
      # verify the required parameter 'shipment_id' is set
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FbaInboundApi.update_inbound_shipment" if shipment_id.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/shipments/{shipmentId}".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
    ...
    # @param shipment_id A shipment identifier originally returned by the createInboundShipmentPlan operation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VoidTransportResponse, Fixnum, Hash)>] VoidTransportResponse data, response status code and response headers
    def void_transport_with_http_info(shipment_id, opts = {})
      ...
      # verify the required parameter 'shipment_id' is set
      fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FbaInboundApi.void_transport" if shipment_id.nil?
      # resource path
      local_var_path = "/fba/inbound/v0/shipments/{shipmentId}/transport/void".sub('{format}','json').sub('{' + 'shipmentId' + '}', shipment_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VoidTransportResponse')
      if @api_client.config.debugging
