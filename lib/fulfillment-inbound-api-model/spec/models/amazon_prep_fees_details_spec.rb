...
# Unit tests for AmzSpApi::FulfillmentInboundApiModel::AmazonPrepFeesDetails
...
describe 'AmazonPrepFeesDetails' do
  ...
  describe 'test an instance of AmazonPrepFeesDetails' do
    it 'should create an instact of AmazonPrepFeesDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModel::AmazonPrepFeesDetails)
    end
  end
